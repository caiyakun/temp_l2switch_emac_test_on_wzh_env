...
/* I2S_TX_SYNC_INT_RAW : RO/WTC/SS ;bitpos:[4] ;default: 1'b0 ; */
/*description: The raw interrupt status bit  for the i2s_tx_sync_int interrupt.*/
#define I2S_TX_SYNC_INT_RAW    (BIT(4))
#define I2S_TX_SYNC_INT_RAW_M  (BIT(4))
#define I2S_TX_SYNC_INT_RAW_V  0x1
...
/* I2S_RX_HUNG_INT_RAW : RO/WTC/SS ;bitpos:[2] ;default: 1'b0 ; */
...
/* I2S_TX_DONE_INT_RAW : RO/WTC/SS ;bitpos:[1] ;default: 1'b0 ; */
...
/* I2S_RX_DONE_INT_RAW : RO/WTC/SS ;bitpos:[0] ;default: 1'b0 ; */
...
/* I2S_TX_SYNC_INT_ST : RO ;bitpos:[4] ;default: 1'b0 ; */
/*description: The masked interrupt status bit  for the i2s_tx_sync_int interrupt.*/
#define I2S_TX_SYNC_INT_ST    (BIT(4))
#define I2S_TX_SYNC_INT_ST_M  (BIT(4))
#define I2S_TX_SYNC_INT_ST_V  0x1
...
/* I2S_TX_SYNC_INT_ENA : R/W ;bitpos:[4] ;default: 1'b0 ; */
/*description: The interrupt enable bit  for the i2s_tx_sync_int interrupt.*/
#define I2S_TX_SYNC_INT_ENA    (BIT(4))
#define I2S_TX_SYNC_INT_ENA_M  (BIT(4))
#define I2S_TX_SYNC_INT_ENA_V  0x1
...
/* I2S_TX_SYNC_INT_CLR : WT ;bitpos:[4] ;default: 1'b0 ; */
/*description: Set this bit to clear the i2s_tx_sync_int interrupt.*/
#define I2S_TX_SYNC_INT_CLR    (BIT(4))
#define I2S_TX_SYNC_INT_CLR_M  (BIT(4))
#define I2S_TX_SYNC_INT_CLR_V  0x1
#define I2S_TX_SYNC_INT_CLR_S  4
/* I2S_TX_HUNG_INT_CLR : WT ;bitpos:[3] ;default: 1'b0 ; */
...
/* I2S_RX_HUNG_INT_CLR : WT ;bitpos:[2] ;default: 1'b0 ; */
...
/* I2S_TX_DONE_INT_CLR : WT ;bitpos:[1] ;default: 1'b0 ; */
...
/* I2S_RX_DONE_INT_CLR : WT ;bitpos:[0] ;default: 1'b0 ; */
...
/* I2S_RX_BCK_DIV_NUM : R/W ;bitpos:[26:21] ;default: 6'd6 ; */
...
/*description: I2S Rx bit endian. 1:small endian, the LSB is received first. 0:big endian, the
...
/* I2S_RX_DONE_MODE : R/W ;bitpos:[14] ;default: 1'h0 ; */
/*description: 1: I2S trigger rx_done when in_suc_eof is 1. 0: I2S trigger rx_done when RX FIFO
 is full..*/
#define I2S_RX_DONE_MODE    (BIT(14))
#define I2S_RX_DONE_MODE_M  (BIT(14))
#define I2S_RX_DONE_MODE_V  0x1
#define I2S_RX_DONE_MODE_S  14
/* I2S_RX_MSB_SHIFT : R/W ;bitpos:[13] ;default: 1'b1 ; */
/*description: Set this bit to enable receiver in Phillips standard mode.*/
#define I2S_RX_MSB_SHIFT    (BIT(13))
#define I2S_RX_MSB_SHIFT_M  (BIT(13))
...
/*description: I2S RX compress/decompress configuration bit. & 0 (atol): A-Law decompress, 1 (l
toa) : A-Law compress, 2 (utol) : u-Law decompress, 3 (ltou) : u-Law compress. &.*/
...
/*description: 1: The first channel data value is valid in I2S RX mono mode.   0: The second ch
annel data value is valid in I2S RX mono mode..*/
...
/* I2S_RX_UPDATE : R/W/SC ;bitpos:[8] ;default: 1'b0 ; */
/*description: Set 1 to update I2S RX registers from APB clock domain to I2S RX clock domain. T
his bit will be cleared by hardware after update register done..*/
...
/*description: I2S Rx byte endian, 1: low addr value to high addr. 0: low addr with low addr va
lue..*/
#define I2S_RX_BIG_ENDIAN    (BIT(7))
#define I2S_RX_BIG_ENDIAN_M  (BIT(7))
#define I2S_RX_BIG_ENDIAN_V  0x1
#define I2S_RX_BIG_ENDIAN_S  7
/* I2S_RX_MONO : R/W ;bitpos:[6] ;default: 1'b0 ; */
/*description: Set this bit to enable receiver  in mono mode.*/
#define I2S_RX_MONO    (BIT(6))
#define I2S_RX_MONO_M  (BIT(6))
#define I2S_RX_MONO_V  0x1
#define I2S_RX_MONO_S  6
/* I2S_RX_STOP_MODE : R/W ;bitpos:[5:4] ;default: 2'd0 ; */
/*description: 0  : I2S Rx only stop when reg_rx_start is cleared.   1: Stop when reg_rx_start
is 0 or in_suc_eof is 1.   2:  Stop I2S RX when reg_rx_start is 0 or RX FIFO is
full..*/
...
/* I2S_RX_START : R/W/SC ;bitpos:[2] ;default: 1'b0 ; */
...
/* I2S_RX_FIFO_RESET : WT ;bitpos:[1] ;default: 1'b0 ; */
...
/* I2S_RX_RESET : WT ;bitpos:[0] ;default: 1'b0 ; */
...
/* I2S_SIG_LOOPBACK : R/W ;bitpos:[30] ;default: 1'b0 ; */
/*description: Enable signal loop back mode with transmitter module and receiver module sharing
 the same WS and BCK signals..*/
#define I2S_SIG_LOOPBACK    (BIT(30))
#define I2S_SIG_LOOPBACK_M  (BIT(30))
#define I2S_SIG_LOOPBACK_V  0x1
#define I2S_SIG_LOOPBACK_S  30
/* I2S_TX_CHAN_MOD : R/W ;bitpos:[29:27] ;default: 3'b0 ; */
...
/* I2S_TX_BCK_DIV_NUM : R/W ;bitpos:[26:21] ;default: 6'd6 ; */
...
/*description: I2S Tx bit endian. 1:small endian, the LSB is sent first. 0:big endian, the MSB
is sent first..*/
...
/*description: 0: WS should be 0 when sending left channel data, and WS is 1in right channel.
...
/* I2S_TX_BCK_NO_DLY : R/W ;bitpos:[14] ;default: 1'b1 ; */
/*description: 1: BCK is not delayed to generate pos/neg edge in master mode. 0: BCK is delayed
 to generate pos/neg edge in master mode..*/
#define I2S_TX_BCK_NO_DLY    (BIT(14))
#define I2S_TX_BCK_NO_DLY_M  (BIT(14))
#define I2S_TX_BCK_NO_DLY_V  0x1
#define I2S_TX_BCK_NO_DLY_S  14
/* I2S_TX_MSB_SHIFT : R/W ;bitpos:[13] ;default: 1'b1 ; */
/*description: Set this bit to enable transmitter in Phillips standard mode.*/
#define I2S_TX_MSB_SHIFT    (BIT(13))
#define I2S_TX_MSB_SHIFT_M  (BIT(13))
...
/*description: I2S TX compress/decompress configuration bit. & 0 (atol): A-Law decompress, 1 (l
toa) : A-Law compress, 2 (utol) : u-Law decompress, 3 (ltou) : u-Law compress. &.*/
...
/*description: 1: The first channel data value is valid in I2S TX mono mode.   0: The second ch
annel data value is valid in I2S TX mono mode..*/
...
/* I2S_TX_UPDATE : R/W/SC ;bitpos:[8] ;default: 1'b0 ; */
/*description: Set 1 to update I2S TX registers from APB clock domain to I2S TX clock domain. T
his bit will be cleared by hardware after update register done..*/
...
/* I2S_TX_MONO : R/W ;bitpos:[6] ;default: 1'b0 ; */
/*description: Set this bit to enable transmitter in mono mode.*/
#define I2S_TX_MONO    (BIT(6))
#define I2S_TX_MONO_M  (BIT(6))
#define I2S_TX_MONO_V  0x1
#define I2S_TX_MONO_S  6
/* I2S_TX_CHAN_EQUAL : R/W ;bitpos:[5] ;default: 1'b0 ; */
/*description: 1: The value of Left channel data is equal to the value of right channel data in
 I2S TX mono mode or TDM channel select mode. 0: The invalid channel data is reg
_i2s_single_data in I2S TX mono mode or TDM channel select mode..*/
#define I2S_TX_CHAN_EQUAL    (BIT(5))
#define I2S_TX_CHAN_EQUAL_M  (BIT(5))
#define I2S_TX_CHAN_EQUAL_V  0x1
#define I2S_TX_CHAN_EQUAL_S  5
/* I2S_TX_STOP_EN : R/W ;bitpos:[4] ;default: 1'h1 ; */
/*description: Set this bit to stop disable output BCK signal and WS signal when tx FIFO is emt
py.*/
#define I2S_TX_STOP_EN    (BIT(4))
#define I2S_TX_STOP_EN_M  (BIT(4))
...
/* I2S_TX_START : R/W/SC ;bitpos:[2] ;default: 1'b0 ; */
...
/* I2S_TX_FIFO_RESET : WT ;bitpos:[1] ;default: 1'b0 ; */
...
/* I2S_TX_RESET : WT ;bitpos:[0] ;default: 1'b0 ; */
...
/* I2S_RX_TDM_CHAN_BITS : R/W ;bitpos:[31:27] ;default: 5'hf ; */
...
/* I2S_RX_HALF_SAMPLE_BITS : R/W ;bitpos:[26:19] ;default: 8'hf ; */
/*description: I2S Rx half sample bits -1..*/
#define I2S_RX_HALF_SAMPLE_BITS    0x000000FF
#define I2S_RX_HALF_SAMPLE_BITS_M  ((I2S_RX_HALF_SAMPLE_BITS_V)<<(I2S_RX_HALF_SAMPLE_BITS_S))
#define I2S_RX_HALF_SAMPLE_BITS_V  0xFF
#define I2S_RX_HALF_SAMPLE_BITS_S  19
/* I2S_RX_BITS_MOD : R/W ;bitpos:[18:14] ;default: 5'hf ; */
/*description: Set the bits to configure the valid data bit length of I2S receiver channel. 7:
all the valid channel data is in 8-bit-mode. 15: all the valid channel data is i
n 16-bit-mode. 23: all the valid channel data is in 24-bit-mode. 31:all the vali
d channel data is in 32-bit-mode..*/
...
/* I2S_RX_TDM_WS_WIDTH : R/W ;bitpos:[8:0] ;default: 9'h0 ; */
/*description:  The width of rx_ws_out at idle level in TDM mode is (I2S_RX_TDM_WS_WIDTH[8:0] +
1) * T_bck.*/
#define I2S_RX_TDM_WS_WIDTH    0x000001FF
#define I2S_RX_TDM_WS_WIDTH_M  ((I2S_RX_TDM_WS_WIDTH_V)<<(I2S_RX_TDM_WS_WIDTH_S))
#define I2S_RX_TDM_WS_WIDTH_V  0x1FF
#define I2S_RX_TDM_WS_WIDTH_S  0

#define I2S_TX_CONF1_REG(i)          (REG_I2S_BASE(i) + 0x2C)
/* I2S_TX_TDM_CHAN_BITS : R/W ;bitpos:[31:27] ;default: 5'hf ; */
...
/* I2S_TX_HALF_SAMPLE_BITS : R/W ;bitpos:[26:19] ;default: 8'hf ; */
/*description:  I2S Tx half sample bits -1..*/
#define I2S_TX_HALF_SAMPLE_BITS    0x000000FF
#define I2S_TX_HALF_SAMPLE_BITS_M  ((I2S_TX_HALF_SAMPLE_BITS_V)<<(I2S_TX_HALF_SAMPLE_BITS_S))
#define I2S_TX_HALF_SAMPLE_BITS_V  0xFF
#define I2S_TX_HALF_SAMPLE_BITS_S  19
/* I2S_TX_BITS_MOD : R/W ;bitpos:[18:14] ;default: 5'hf ; */
/*description: Set the bits to configure the valid data bit length of I2S transmitter channel.
7: all the valid channel data is in 8-bit-mode. 15: all the valid channel data i
s in 16-bit-mode. 23: all the valid channel data is in 24-bit-mode. 31:all the v
alid channel data is in 32-bit-mode..*/
...
/* I2S_TX_TDM_WS_WIDTH : R/W ;bitpos:[8:0] ;default: 9'h0 ; */
/*description:  The width of tx_ws_out at idle level in TDM mode is (I2S_TX_TDM_WS_WIDTH[8:0] +
1) * T_bck.*/
#define I2S_TX_TDM_WS_WIDTH    0x000001FF
#define I2S_TX_TDM_WS_WIDTH_M  ((I2S_TX_TDM_WS_WIDTH_V)<<(I2S_TX_TDM_WS_WIDTH_S))
#define I2S_TX_TDM_WS_WIDTH_V  0x1FF
#define I2S_TX_TDM_WS_WIDTH_S  0

#define I2S_RX_RECOMB_CTRL_REG(i)          (REG_I2S_BASE(i) + 0x30)
/* I2S_RX_RECOMB_UPDATE : WT ;bitpos:[31] ;default: 1'b0 ; */
/*description: Set this bit to update i2s data recombination configuration, must be performed a
fter changing the config of any recombined-dma-channel..*/
#define I2S_RX_RECOMB_UPDATE    (BIT(31))
#define I2S_RX_RECOMB_UPDATE_M  (BIT(31))
#define I2S_RX_RECOMB_UPDATE_V  0x1
#define I2S_RX_RECOMB_UPDATE_S  31
/* I2S_RX_RECOMB_EXT_CH_NUM : R/W ;bitpos:[2:1] ;default: 2'd0 ; */
/*description: The channel number that i2s will extract the data into..*/
#define I2S_RX_RECOMB_EXT_CH_NUM    0x00000003
#define I2S_RX_RECOMB_EXT_CH_NUM_M  ((I2S_RX_RECOMB_EXT_CH_NUM_V)<<(I2S_RX_RECOMB_EXT_CH_NUM_S))
#define I2S_RX_RECOMB_EXT_CH_NUM_V  0x3
#define I2S_RX_RECOMB_EXT_CH_NUM_S  1
/* I2S_RX_RECOMB_EN : R/W ;bitpos:[0] ;default: 1'h0 ; */
/*description: Set this bit to enable i2s rx data recombination..*/
#define I2S_RX_RECOMB_EN    (BIT(0))
#define I2S_RX_RECOMB_EN_M  (BIT(0))
#define I2S_RX_RECOMB_EN_V  0x1
#define I2S_RX_RECOMB_EN_S  0

#define I2S_RX_RECOMB_DMA_CH0_REG(i)          (REG_I2S_BASE(i) + 0x34)
/* I2S_RX_RECOMB_DMA_CH0_EOF_NUM : R/W ;bitpos:[28:13] ;default: 16'h0 ; */
/*description: Set this field to set the receive eof byte length of the recombined-dma-channel..*/
#define I2S_RX_RECOMB_DMA_CH0_EOF_NUM    0x0000FFFF
#define I2S_RX_RECOMB_DMA_CH0_EOF_NUM_M  ((I2S_RX_RECOMB_DMA_CH0_EOF_NUM_V)<<(I2S_RX_RECOMB_DMA_CH0_EOF_NUM_S))
#define I2S_RX_RECOMB_DMA_CH0_EOF_NUM_V  0xFFFF
#define I2S_RX_RECOMB_DMA_CH0_EOF_NUM_S  13
/* I2S_RX_RECOMB_DMA_CH0_ORDER : R/W ;bitpos:[12:5] ;default: 8'h0 ; */
/*description: Set this field to set the recombined-dma-channel order. If choose to use the ord
er ch3 -> ch1, the order should be: 8'd7 = {2'd0,2'd0,2'd1,2'd3}..*/
#define I2S_RX_RECOMB_DMA_CH0_ORDER    0x000000FF
#define I2S_RX_RECOMB_DMA_CH0_ORDER_M  ((I2S_RX_RECOMB_DMA_CH0_ORDER_V)<<(I2S_RX_RECOMB_DMA_CH0_ORDER_S))
#define I2S_RX_RECOMB_DMA_CH0_ORDER_V  0xFF
#define I2S_RX_RECOMB_DMA_CH0_ORDER_S  5
/* I2S_RX_RECOMB_DMA_CH0_STYLE : R/W ;bitpos:[4:1] ;default: 4'b0000 ; */
/*description: Set this field to set the recombined-dma-channel style. If choose to use i2s ext
racted ch 1&3 in 4 channels, the style should be: 6'b1010..*/
#define I2S_RX_RECOMB_DMA_CH0_STYLE    0x0000000F
#define I2S_RX_RECOMB_DMA_CH0_STYLE_M  ((I2S_RX_RECOMB_DMA_CH0_STYLE_V)<<(I2S_RX_RECOMB_DMA_CH0_STYLE_S))
#define I2S_RX_RECOMB_DMA_CH0_STYLE_V  0xF
#define I2S_RX_RECOMB_DMA_CH0_STYLE_S  1
/* I2S_RX_RECOMB_DMA_CH0_VALID : R/W ;bitpos:[0] ;default: 1'b0 ; */
/*description: Set this bit to enable the adc-dma-channel..*/
#define I2S_RX_RECOMB_DMA_CH0_VALID    (BIT(0))
#define I2S_RX_RECOMB_DMA_CH0_VALID_M  (BIT(0))
#define I2S_RX_RECOMB_DMA_CH0_VALID_V  0x1
#define I2S_RX_RECOMB_DMA_CH0_VALID_S  0

#define I2S_RX_RECOMB_DMA_CH1_REG(i)          (REG_I2S_BASE(i) + 0x38)
/* I2S_RX_RECOMB_DMA_CH1_EOF_NUM : R/W ;bitpos:[28:13] ;default: 16'h0 ; */
/*description: Set this field to set the receive eof byte length of the recombined-dma-channel..*/
#define I2S_RX_RECOMB_DMA_CH1_EOF_NUM    0x0000FFFF
#define I2S_RX_RECOMB_DMA_CH1_EOF_NUM_M  ((I2S_RX_RECOMB_DMA_CH1_EOF_NUM_V)<<(I2S_RX_RECOMB_DMA_CH1_EOF_NUM_S))
#define I2S_RX_RECOMB_DMA_CH1_EOF_NUM_V  0xFFFF
#define I2S_RX_RECOMB_DMA_CH1_EOF_NUM_S  13
/* I2S_RX_RECOMB_DMA_CH1_ORDER : R/W ;bitpos:[12:5] ;default: 8'h0 ; */
/*description: Set this field to set the recombined-dma-channel order. If choose to use the ord
er ch3 -> ch1, the order should be: 8'd7 = {2'd0,2'd0,2'd1,2'd3}..*/
#define I2S_RX_RECOMB_DMA_CH1_ORDER    0x000000FF
#define I2S_RX_RECOMB_DMA_CH1_ORDER_M  ((I2S_RX_RECOMB_DMA_CH1_ORDER_V)<<(I2S_RX_RECOMB_DMA_CH1_ORDER_S))
#define I2S_RX_RECOMB_DMA_CH1_ORDER_V  0xFF
#define I2S_RX_RECOMB_DMA_CH1_ORDER_S  5
/* I2S_RX_RECOMB_DMA_CH1_STYLE : R/W ;bitpos:[4:1] ;default: 4'b0000 ; */
/*description: Set this field to set the recombined-dma-channel style. If choose to use i2s ext
racted ch 1&3 in 4 channels, the style should be: 6'b1010..*/
#define I2S_RX_RECOMB_DMA_CH1_STYLE    0x0000000F
#define I2S_RX_RECOMB_DMA_CH1_STYLE_M  ((I2S_RX_RECOMB_DMA_CH1_STYLE_V)<<(I2S_RX_RECOMB_DMA_CH1_STYLE_S))
#define I2S_RX_RECOMB_DMA_CH1_STYLE_V  0xF
#define I2S_RX_RECOMB_DMA_CH1_STYLE_S  1
/* I2S_RX_RECOMB_DMA_CH1_VALID : R/W ;bitpos:[0] ;default: 1'b0 ; */
/*description: Set this bit to enable the adc-dma-channel..*/
#define I2S_RX_RECOMB_DMA_CH1_VALID    (BIT(0))
#define I2S_RX_RECOMB_DMA_CH1_VALID_M  (BIT(0))
#define I2S_RX_RECOMB_DMA_CH1_VALID_V  0x1
#define I2S_RX_RECOMB_DMA_CH1_VALID_S  0

#define I2S_RX_RECOMB_DMA_CH2_REG(i)          (REG_I2S_BASE(i) + 0x3C)
/* I2S_RX_RECOMB_DMA_CH2_EOF_NUM : R/W ;bitpos:[28:13] ;default: 16'h0 ; */
/*description: Set this field to set the receive eof byte length of the recombined-dma-channel..*/
#define I2S_RX_RECOMB_DMA_CH2_EOF_NUM    0x0000FFFF
#define I2S_RX_RECOMB_DMA_CH2_EOF_NUM_M  ((I2S_RX_RECOMB_DMA_CH2_EOF_NUM_V)<<(I2S_RX_RECOMB_DMA_CH2_EOF_NUM_S))
#define I2S_RX_RECOMB_DMA_CH2_EOF_NUM_V  0xFFFF
#define I2S_RX_RECOMB_DMA_CH2_EOF_NUM_S  13
/* I2S_RX_RECOMB_DMA_CH2_ORDER : R/W ;bitpos:[12:5] ;default: 8'h0 ; */
/*description: Set this field to set the recombined-dma-channel order. If choose to use the ord
er ch3 -> ch1, the order should be: 8'd7 = {2'd0,2'd0,2'd1,2'd3}..*/
#define I2S_RX_RECOMB_DMA_CH2_ORDER    0x000000FF
#define I2S_RX_RECOMB_DMA_CH2_ORDER_M  ((I2S_RX_RECOMB_DMA_CH2_ORDER_V)<<(I2S_RX_RECOMB_DMA_CH2_ORDER_S))
#define I2S_RX_RECOMB_DMA_CH2_ORDER_V  0xFF
#define I2S_RX_RECOMB_DMA_CH2_ORDER_S  5
/* I2S_RX_RECOMB_DMA_CH2_STYLE : R/W ;bitpos:[4:1] ;default: 4'b0000 ; */
/*description: Set this field to set the recombined-dma-channel style. If choose to use i2s ext
racted ch 1&3 in 4 channels, the style should be: 6'b1010..*/
#define I2S_RX_RECOMB_DMA_CH2_STYLE    0x0000000F
#define I2S_RX_RECOMB_DMA_CH2_STYLE_M  ((I2S_RX_RECOMB_DMA_CH2_STYLE_V)<<(I2S_RX_RECOMB_DMA_CH2_STYLE_S))
#define I2S_RX_RECOMB_DMA_CH2_STYLE_V  0xF
#define I2S_RX_RECOMB_DMA_CH2_STYLE_S  1
/* I2S_RX_RECOMB_DMA_CH2_VALID : R/W ;bitpos:[0] ;default: 1'b0 ; */
/*description: Set this bit to enable the adc-dma-channel..*/
#define I2S_RX_RECOMB_DMA_CH2_VALID    (BIT(0))
#define I2S_RX_RECOMB_DMA_CH2_VALID_M  (BIT(0))
#define I2S_RX_RECOMB_DMA_CH2_VALID_V  0x1
#define I2S_RX_RECOMB_DMA_CH2_VALID_S  0

#define I2S_RX_RECOMB_DMA_CH3_REG(i)          (REG_I2S_BASE(i) + 0x40)
/* I2S_RX_RECOMB_DMA_CH3_EOF_NUM : R/W ;bitpos:[28:13] ;default: 16'h0 ; */
/*description: Set this field to set the receive eof byte length of the recombined-dma-channel..*/
#define I2S_RX_RECOMB_DMA_CH3_EOF_NUM    0x0000FFFF
#define I2S_RX_RECOMB_DMA_CH3_EOF_NUM_M  ((I2S_RX_RECOMB_DMA_CH3_EOF_NUM_V)<<(I2S_RX_RECOMB_DMA_CH3_EOF_NUM_S))
#define I2S_RX_RECOMB_DMA_CH3_EOF_NUM_V  0xFFFF
#define I2S_RX_RECOMB_DMA_CH3_EOF_NUM_S  13
/* I2S_RX_RECOMB_DMA_CH3_ORDER : R/W ;bitpos:[12:5] ;default: 8'h0 ; */
/*description: Set this field to set the recombined-dma-channel order. If choose to use the ord
er ch3 -> ch1, the order should be: 8'd7 = {2'd0,2'd0,2'd1,2'd3}..*/
#define I2S_RX_RECOMB_DMA_CH3_ORDER    0x000000FF
#define I2S_RX_RECOMB_DMA_CH3_ORDER_M  ((I2S_RX_RECOMB_DMA_CH3_ORDER_V)<<(I2S_RX_RECOMB_DMA_CH3_ORDER_S))
#define I2S_RX_RECOMB_DMA_CH3_ORDER_V  0xFF
#define I2S_RX_RECOMB_DMA_CH3_ORDER_S  5
/* I2S_RX_RECOMB_DMA_CH3_STYLE : R/W ;bitpos:[4:1] ;default: 4'b0000 ; */
/*description: Set this field to set the recombined-dma-channel style. If choose to use i2s ext
racted ch 1&3 in 4 channels, the style should be: 6'b1010..*/
#define I2S_RX_RECOMB_DMA_CH3_STYLE    0x0000000F
#define I2S_RX_RECOMB_DMA_CH3_STYLE_M  ((I2S_RX_RECOMB_DMA_CH3_STYLE_V)<<(I2S_RX_RECOMB_DMA_CH3_STYLE_S))
#define I2S_RX_RECOMB_DMA_CH3_STYLE_V  0xF
#define I2S_RX_RECOMB_DMA_CH3_STYLE_S  1
/* I2S_RX_RECOMB_DMA_CH3_VALID : R/W ;bitpos:[0] ;default: 1'b0 ; */
/*description: Set this bit to enable the adc-dma-channel..*/
#define I2S_RX_RECOMB_DMA_CH3_VALID    (BIT(0))
#define I2S_RX_RECOMB_DMA_CH3_VALID_M  (BIT(0))
#define I2S_RX_RECOMB_DMA_CH3_VALID_V  0x1
...
/* I2S_RX_IIR_HP_MULT12_0 : R/W ;bitpos:[31:29] ;default: 3'h7 ; */
/*description: The fourth parameter of PDM RX IIR_HP filter stage 1 is (504 + LP_I2S_RX_IIR_HP_
MULT12_0[2:0]).*/
#define I2S_RX_IIR_HP_MULT12_0    0x00000007
#define I2S_RX_IIR_HP_MULT12_0_M  ((I2S_RX_IIR_HP_MULT12_0_V)<<(I2S_RX_IIR_HP_MULT12_0_S))
#define I2S_RX_IIR_HP_MULT12_0_V  0x7
#define I2S_RX_IIR_HP_MULT12_0_S  29
/* I2S_RX_IIR_HP_MULT12_5 : R/W ;bitpos:[28:26] ;default: 3'h6 ; */
/*description: The fourth parameter of PDM RX IIR_HP filter stage 2 is (504 + LP_I2S_RX_IIR_HP_
MULT12_5[2:0]).*/
#define I2S_RX_IIR_HP_MULT12_5    0x00000007
#define I2S_RX_IIR_HP_MULT12_5_M  ((I2S_RX_IIR_HP_MULT12_5_V)<<(I2S_RX_IIR_HP_MULT12_5_S))
#define I2S_RX_IIR_HP_MULT12_5_V  0x7
#define I2S_RX_IIR_HP_MULT12_5_S  26
/* I2S_RX_PDM_HP_BYPASS : R/W ;bitpos:[25] ;default: 1'h0 ; */
/*description: I2S PDM RX bypass hp filter or not..*/
#define I2S_RX_PDM_HP_BYPASS    (BIT(25))
#define I2S_RX_PDM_HP_BYPASS_M  (BIT(25))
#define I2S_RX_PDM_HP_BYPASS_V  0x1
#define I2S_RX_PDM_HP_BYPASS_S  25
/* I2S_RX_PDM2PCM_AMPLIFY_NUM : R/W ;bitpos:[24:21] ;default: 4'h1 ; */
/*description: Configure PDM RX amplify number..*/
#define I2S_RX_PDM2PCM_AMPLIFY_NUM    0x0000000F
#define I2S_RX_PDM2PCM_AMPLIFY_NUM_M  ((I2S_RX_PDM2PCM_AMPLIFY_NUM_V)<<(I2S_RX_PDM2PCM_AMPLIFY_NUM_S))
#define I2S_RX_PDM2PCM_AMPLIFY_NUM_V  0xF
#define I2S_RX_PDM2PCM_AMPLIFY_NUM_S  21
/* I2S_RX_PDM_SINC_DSR_16_EN : R/W ;bitpos:[20] ;default: 1'h0 ; */
/*description: Configure the down sampling rate of PDM RX filter group1 module. 1: The  down sa
mpling rate is 128. 0: down sampling rate is 64..*/
#define I2S_RX_PDM_SINC_DSR_16_EN    (BIT(20))
#define I2S_RX_PDM_SINC_DSR_16_EN_M  (BIT(20))
#define I2S_RX_PDM_SINC_DSR_16_EN_V  0x1
#define I2S_RX_PDM_SINC_DSR_16_EN_S  20
/* I2S_RX_PDM2PCM_EN : R/W ;bitpos:[19] ;default: 1'h0 ; */
/*description: 1: Enable PDM2PCM RX mode. 0: DIsable..*/
#define I2S_RX_PDM2PCM_EN    (BIT(19))
#define I2S_RX_PDM2PCM_EN_M  (BIT(19))
...
/*description: 1: Enable the valid data input of I2S RX TDM channel $n. 0:  Disable, just input
 0 in this channel..*/
...
/*description: 1: Enable the valid data output of I2S TX TDM channel $n. 0:  Disable, just outp
ut 0 in this channel..*/
...
/*description: The delay mode of I2S Rx BCK input signal. 0: bypass. 1: delay by pos edge.  2:
...
/*description: The delay mode of I2S Rx WS input signal. 0: bypass. 1: delay by pos edge.  2: d
elay by neg edge. 3: not used..*/
...
/*description: The delay mode of I2S Rx BCK output signal. 0: bypass. 1: delay by pos edge.  2:
 delay by neg edge. 3: not used..*/
...
/*description: The delay mode of I2S Rx WS output signal. 0: bypass. 1: delay by pos edge.  2:
delay by neg edge. 3: not used..*/
...
/*description: The delay mode of I2S Rx SD3 input signal. 0: bypass. 1: delay by pos edge.  2:
delay by neg edge. 3: not used..*/
...
/*description: The delay mode of I2S Rx SD2 input signal. 0: bypass. 1: delay by pos edge.  2:
delay by neg edge. 3: not used..*/
...
/*description: The delay mode of I2S Rx SD1 input signal. 0: bypass. 1: delay by pos edge.  2:
delay by neg edge. 3: not used..*/
...
/*description: The delay mode of I2S Rx SD input signal. 0: bypass. 1: delay by pos edge.  2: d
elay by neg edge. 3: not used..*/
...
/*description: The delay mode of I2S TX BCK input signal. 0: bypass. 1: delay by pos edge.  2:
delay by neg edge. 3: not used..*/
...
/*description: The delay mode of I2S TX WS input signal. 0: bypass. 1: delay by pos edge.  2: d
elay by neg edge. 3: not used..*/
...
/*description: The delay mode of I2S TX BCK output signal. 0: bypass. 1: delay by pos edge.  2:
 delay by neg edge. 3: not used..*/
...
/*description: The delay mode of I2S TX WS output signal. 0: bypass. 1: delay by pos edge.  2:
delay by neg edge. 3: not used..*/
...
/*description: The delay mode of I2S TX SD output signal. 0: bypass. 1: delay by pos edge.  2:
delay by neg edge. 3: not used..*/
...
/*description: the i2s_tx_hung_int interrupt or the i2s_rx_hung_int interrupt will be triggered
...
/* I2S_RX_EOF_NUM : R/W ;bitpos:[15:0] ;default: 16'h40 ; */
/*description: The receive data bit length is (I2S_RX_BITS_MOD[4:0] + 1) * (REG_RX_EOF_NUM[15:0
]) . It will trigger in_suc_eof interrupt in the configured DMA RX channel..*/
#define I2S_RX_EOF_NUM    0x0000FFFF
#define I2S_RX_EOF_NUM_M  ((I2S_RX_EOF_NUM_V)<<(I2S_RX_EOF_NUM_S))
#define I2S_RX_EOF_NUM_V  0xFFFF
...
/* I2S_ETM_RX_RECEIVE_WORD_NUM : R/W ;bitpos:[27:14] ;default: 14'h40 ; */
/*description: I2S ETM receive x words event. When receiving word number of reg_etm_rx_receive_
word_num[13:0], i2s will trigger an etm event..*/
#define I2S_ETM_RX_RECEIVE_WORD_NUM    0x00003FFF
#define I2S_ETM_RX_RECEIVE_WORD_NUM_M  ((I2S_ETM_RX_RECEIVE_WORD_NUM_V)<<(I2S_ETM_RX_RECEIVE_WORD_NUM_S))
#define I2S_ETM_RX_RECEIVE_WORD_NUM_V  0x3FFF
#define I2S_ETM_RX_RECEIVE_WORD_NUM_S  14
/* I2S_ETM_TX_SEND_WORD_NUM : R/W ;bitpos:[13:0] ;default: 14'h40 ; */
/*description: I2S ETM send x words event. When sending word number of reg_etm_tx_send_word_num
[13:0], i2s will trigger an etm event..*/
#define I2S_ETM_TX_SEND_WORD_NUM    0x00003FFF
#define I2S_ETM_TX_SEND_WORD_NUM_M  ((I2S_ETM_TX_SEND_WORD_NUM_V)<<(I2S_ETM_TX_SEND_WORD_NUM_S))
#define I2S_ETM_TX_SEND_WORD_NUM_V  0x3FFF
#define I2S_ETM_TX_SEND_WORD_NUM_S  0

#define I2S_IDEAL_CNT_REG(i)          (REG_I2S_BASE(i) + 0x74)
/* I2S_TX_IDEAL_CNT : R/W ;bitpos:[30:0] ;default: 31'h0 ; */
/*description: tx fifo counter ideal value..*/
#define I2S_TX_IDEAL_CNT    0x7FFFFFFF
#define I2S_TX_IDEAL_CNT_M  ((I2S_TX_IDEAL_CNT_V)<<(I2S_TX_IDEAL_CNT_S))
#define I2S_TX_IDEAL_CNT_V  0x7FFFFFFF
#define I2S_TX_IDEAL_CNT_S  0

#define I2S_SYNC_CNT_THRES_REG(i)          (REG_I2S_BASE(i) + 0x78)
/* I2S_TX_CNT_DIFF_THRESHOLD : R/W ;bitpos:[30:0] ;default: 31'h0 ; */
/*description: tx fifo counter difference threshold value..*/
#define I2S_TX_CNT_DIFF_THRESHOLD    0x7FFFFFFF
#define I2S_TX_CNT_DIFF_THRESHOLD_M  ((I2S_TX_CNT_DIFF_THRESHOLD_V)<<(I2S_TX_CNT_DIFF_THRESHOLD_S))
#define I2S_TX_CNT_DIFF_THRESHOLD_V  0x7FFFFFFF
#define I2S_TX_CNT_DIFF_THRESHOLD_S  0

#define I2S_FIFO_CNT_REG(i)          (REG_I2S_BASE(i) + 0x7C)
/* I2S_TX_FIFO_CNT_RST : WT ;bitpos:[31] ;default: 1'b0 ; */
/*description: Set this bit to reset tx fifo counter..*/
#define I2S_TX_FIFO_CNT_RST    (BIT(31))
#define I2S_TX_FIFO_CNT_RST_M  (BIT(31))
#define I2S_TX_FIFO_CNT_RST_V  0x1
#define I2S_TX_FIFO_CNT_RST_S  31
/* I2S_TX_FIFO_CNT : RO ;bitpos:[30:0] ;default: 31'h0 ; */
/*description: tx fifo counter value..*/
#define I2S_TX_FIFO_CNT    0x7FFFFFFF
#define I2S_TX_FIFO_CNT_M  ((I2S_TX_FIFO_CNT_V)<<(I2S_TX_FIFO_CNT_S))
#define I2S_TX_FIFO_CNT_V  0x7FFFFFFF
#define I2S_TX_FIFO_CNT_S  0

#define I2S_BCK_CNT_REG(i)          (REG_I2S_BASE(i) + 0x80)
/* I2S_TX_BCK_CNT_RST : WT ;bitpos:[31] ;default: 1'b0 ; */
/*description: Set this bit to reset tx bck counter..*/
#define I2S_TX_BCK_CNT_RST    (BIT(31))
#define I2S_TX_BCK_CNT_RST_M  (BIT(31))
#define I2S_TX_BCK_CNT_RST_V  0x1
#define I2S_TX_BCK_CNT_RST_S  31
/* I2S_TX_BCK_CNT : RO ;bitpos:[30:0] ;default: 31'h0 ; */
/*description: tx bck counter value..*/
#define I2S_TX_BCK_CNT    0x7FFFFFFF
#define I2S_TX_BCK_CNT_M  ((I2S_TX_BCK_CNT_V)<<(I2S_TX_BCK_CNT_S))
#define I2S_TX_BCK_CNT_V  0x7FFFFFFF
#define I2S_TX_BCK_CNT_S  0

#define I2S_CNT_DIFF_REG(i)          (REG_I2S_BASE(i) + 0x84)
/* I2S_TX_CNT_DIFF_RST : WT ;bitpos:[31] ;default: 1'b0 ; */
/*description: Set this bit to reset fifo counter difference..*/
#define I2S_TX_CNT_DIFF_RST    (BIT(31))
#define I2S_TX_CNT_DIFF_RST_M  (BIT(31))
#define I2S_TX_CNT_DIFF_RST_V  0x1
#define I2S_TX_CNT_DIFF_RST_S  31
/* I2S_TX_CNT_DIFF : RO ;bitpos:[30:0] ;default: 31'h0 ; */
/*description: tx bck counter value..*/
#define I2S_TX_CNT_DIFF    0x7FFFFFFF
#define I2S_TX_CNT_DIFF_M  ((I2S_TX_CNT_DIFF_V)<<(I2S_TX_CNT_DIFF_S))
#define I2S_TX_CNT_DIFF_V  0x7FFFFFFF
#define I2S_TX_CNT_DIFF_S  0

#define I2S_CLK_GATE_REG(i)          (REG_I2S_BASE(i) + 0xF8)
/* I2S_CLK_EN : R/W ;bitpos:[0] ;default: 1'h0 ; */
/*description: set this bit to enable clock gate.*/
#define I2S_CLK_EN    (BIT(0))
#define I2S_CLK_EN_M  (BIT(0))
#define I2S_CLK_EN_V  0x1
#define I2S_CLK_EN_S  0

#define I2S_DATE_REG(i)          (REG_I2S_BASE(i) + 0xFC)
/* I2S_DATE : R/W ;bitpos:[27:0] ;default: 28'h2405210 ; */
