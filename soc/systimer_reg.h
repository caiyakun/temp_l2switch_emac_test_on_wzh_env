...
/*description: Configures register clock gating. \\; 0: Only enable needed clock for register r
ead or write operations. \\; 1: Register clock is always enabled for read and wr
ite operations. \\.*/
#define SYSTIMER_CLK_EN    (BIT(31))
#define SYSTIMER_CLK_EN_M  (BIT(31))
#define SYSTIMER_CLK_EN_V  0x1
#define SYSTIMER_CLK_EN_S  31
/* SYSTIMER_TIMER_UNIT0_WORK_EN : R/W ;bitpos:[30] ;default: 1'b1 ; */
/*description: Configures whether or not to enable UNIT0. \\; 0: Disable\\; 1: Enable\\.*/
#define SYSTIMER_TIMER_UNIT0_WORK_EN    (BIT(30))
#define SYSTIMER_TIMER_UNIT0_WORK_EN_M  (BIT(30))
#define SYSTIMER_TIMER_UNIT0_WORK_EN_V  0x1
#define SYSTIMER_TIMER_UNIT0_WORK_EN_S  30
/* SYSTIMER_TIMER_UNIT1_WORK_EN : R/W ;bitpos:[29] ;default: 1'b0 ; */
/*description: Configures whether or not to enable UNIT1. \\; 0: Disable\\; 1: Enable\\.*/
#define SYSTIMER_TIMER_UNIT1_WORK_EN    (BIT(29))
#define SYSTIMER_TIMER_UNIT1_WORK_EN_M  (BIT(29))
#define SYSTIMER_TIMER_UNIT1_WORK_EN_V  0x1
#define SYSTIMER_TIMER_UNIT1_WORK_EN_S  29
/* SYSTIMER_TIMER_UNIT0_CORE0_STALL_EN : R/W ;bitpos:[28] ;default: 1'b0 ; */
/*description: Configures whether or not UNIT0 is stalled when CORE0 is stalled. See details in
 SYSTIMER_TIMER_UNIT1_CORE1_STALL_EN..*/
#define SYSTIMER_TIMER_UNIT0_CORE0_STALL_EN    (BIT(28))
#define SYSTIMER_TIMER_UNIT0_CORE0_STALL_EN_M  (BIT(28))
#define SYSTIMER_TIMER_UNIT0_CORE0_STALL_EN_V  0x1
#define SYSTIMER_TIMER_UNIT0_CORE0_STALL_EN_S  28
/* SYSTIMER_TIMER_UNIT0_CORE1_STALL_EN : R/W ;bitpos:[27] ;default: 1'b0 ; */
/*description: Configures whether or not UNIT0 is stalled when CORE1 is stalled. See details in
 SYSTIMER_TIMER_UNIT1_CORE1_STALL_EN..*/
#define SYSTIMER_TIMER_UNIT0_CORE1_STALL_EN    (BIT(27))
#define SYSTIMER_TIMER_UNIT0_CORE1_STALL_EN_M  (BIT(27))
#define SYSTIMER_TIMER_UNIT0_CORE1_STALL_EN_V  0x1
#define SYSTIMER_TIMER_UNIT0_CORE1_STALL_EN_S  27
/* SYSTIMER_TIMER_UNIT1_CORE0_STALL_EN : R/W ;bitpos:[26] ;default: 1'b1 ; */
/*description: Configures whether or not UNIT1 is stalled when CORE0 is stalled. See details in
 SYSTIMER_TIMER_UNIT1_CORE1_STALL_EN..*/
#define SYSTIMER_TIMER_UNIT1_CORE0_STALL_EN    (BIT(26))
#define SYSTIMER_TIMER_UNIT1_CORE0_STALL_EN_M  (BIT(26))
#define SYSTIMER_TIMER_UNIT1_CORE0_STALL_EN_V  0x1
#define SYSTIMER_TIMER_UNIT1_CORE0_STALL_EN_S  26
/* SYSTIMER_TIMER_UNIT1_CORE1_STALL_EN : R/W ;bitpos:[25] ;default: 1'b1 ; */
/*description: Configures whether or not UNIT1 is stalled when CORE1 is stalled. \\; 0: UNIT1 i
s not stalled. \\; 1: UNIT1 is stalled.\\.*/
#define SYSTIMER_TIMER_UNIT1_CORE1_STALL_EN    (BIT(25))
#define SYSTIMER_TIMER_UNIT1_CORE1_STALL_EN_M  (BIT(25))
#define SYSTIMER_TIMER_UNIT1_CORE1_STALL_EN_V  0x1
#define SYSTIMER_TIMER_UNIT1_CORE1_STALL_EN_S  25
/* SYSTIMER_TARGET0_WORK_EN : R/W ;bitpos:[24] ;default: 1'b0 ; */
/*description: Configures whether or not to enable COMP0. See details in SYSTIMER_TARGET2_WORK_
EN..*/
...
/*description: Configures whether or not to enable COMP1. See details in SYSTIMER_TARGET2_WORK_
EN..*/
...
/*description: Configures whether or not to enable COMP2.\\; 0: Disable\\; 1: Enable\\;.*/
...
/* SYSTIMER_ETM_EN : R/W ;bitpos:[1] ;default: 1'b0 ; */
/*description: Configures whether or not to enable generation of ETM events.\\; 0: Disable\\; 1
: Enable\\.*/
#define SYSTIMER_ETM_EN    (BIT(1))
#define SYSTIMER_ETM_EN_M  (BIT(1))
#define SYSTIMER_ETM_EN_V  0x1
...
/* SYSTIMER_TIMER_UNIT0_UPDATE : WT ;bitpos:[30] ;default: 1'b0 ; */
/*description: Configures whether or not to update timer UNIT0, i.e., reads the UNIT0 count val
ue to SYSTIMER_TIMER_UNIT0_VALUE_HI and SYSTIMER_TIMER_UNIT0_VALUE_LO. \\; 0: No
 effect\\; 1: Update timer UNIT0 \\.*/
#define SYSTIMER_TIMER_UNIT0_UPDATE    (BIT(30))
#define SYSTIMER_TIMER_UNIT0_UPDATE_M  (BIT(30))
#define SYSTIMER_TIMER_UNIT0_UPDATE_V  0x1
#define SYSTIMER_TIMER_UNIT0_UPDATE_S  30
/* SYSTIMER_TIMER_UNIT0_VALUE_VALID : R/SS/WTC ;bitpos:[29] ;default: 1'b0 ; */
/*description: Represents UNIT0 value is synchronized and valid..*/
#define SYSTIMER_TIMER_UNIT0_VALUE_VALID    (BIT(29))
#define SYSTIMER_TIMER_UNIT0_VALUE_VALID_M  (BIT(29))
#define SYSTIMER_TIMER_UNIT0_VALUE_VALID_V  0x1
#define SYSTIMER_TIMER_UNIT0_VALUE_VALID_S  29

#define SYSTIMER_UNIT1_OP_REG          (DR_REG_SYSTIMER_BASE + 0x8)
/* SYSTIMER_TIMER_UNIT1_UPDATE : WT ;bitpos:[30] ;default: 1'b0 ; */
/*description: Configures whether or not to update timer UNIT1, i.e., reads the UNIT1 count val
ue to SYSTIMER_TIMER_UNIT1_VALUE_HI and SYSTIMER_TIMER_UNIT1_VALUE_LO. \\; 0: No
 effect \\; 1: Update timer UNIT1\\.*/
#define SYSTIMER_TIMER_UNIT1_UPDATE    (BIT(30))
#define SYSTIMER_TIMER_UNIT1_UPDATE_M  (BIT(30))
#define SYSTIMER_TIMER_UNIT1_UPDATE_V  0x1
#define SYSTIMER_TIMER_UNIT1_UPDATE_S  30
/* SYSTIMER_TIMER_UNIT1_VALUE_VALID : R/SS/WTC ;bitpos:[29] ;default: 1'b0 ; */
/*description: Represents UNIT1 value is synchronized and valid..*/
#define SYSTIMER_TIMER_UNIT1_VALUE_VALID    (BIT(29))
#define SYSTIMER_TIMER_UNIT1_VALUE_VALID_M  (BIT(29))
#define SYSTIMER_TIMER_UNIT1_VALUE_VALID_V  0x1
#define SYSTIMER_TIMER_UNIT1_VALUE_VALID_S  29

#define SYSTIMER_UNIT0_LOAD_HI_REG          (DR_REG_SYSTIMER_BASE + 0xC)
/* SYSTIMER_TIMER_UNIT0_LOAD_HI : R/W ;bitpos:[19:0] ;default: 20'd0 ; */
/*description: Configures the value to be loaded to UNIT0, high 20 bits..*/
...
#define SYSTIMER_TIMER_UNIT0_LOAD_HI_V  0xFFFFF
#define SYSTIMER_TIMER_UNIT0_LOAD_HI_S  0

#define SYSTIMER_UNIT0_LOAD_LO_REG          (DR_REG_SYSTIMER_BASE + 0x10)
/* SYSTIMER_TIMER_UNIT0_LOAD_LO : R/W ;bitpos:[31:0] ;default: 32'd0 ; */
/*description: Configures the value to be loaded to UNIT0, low 32 bits..*/
...
/* SYSTIMER_TIMER_UNIT1_LOAD_HI : R/W ;bitpos:[19:0] ;default: 20'd0 ; */
/*description: Configures the value to be loaded to UNIT1, high 20 bits..*/
...
#define SYSTIMER_TIMER_UNIT1_LOAD_HI_V  0xFFFFF
#define SYSTIMER_TIMER_UNIT1_LOAD_HI_S  0

#define SYSTIMER_UNIT1_LOAD_LO_REG          (DR_REG_SYSTIMER_BASE + 0x18)
/* SYSTIMER_TIMER_UNIT1_LOAD_LO : R/W ;bitpos:[31:0] ;default: 32'd0 ; */
/*description: Configures the value to be loaded to UNIT1, low 32 bits..*/
...
/* SYSTIMER_TIMER_TARGET0_HI : R/W ;bitpos:[19:0] ;default: 20'd0 ; */
/*description: Configures the alarm value to be loaded to COMP0, high 20 bits..*/
...
#define SYSTIMER_TIMER_TARGET0_HI_V  0xFFFFF
#define SYSTIMER_TIMER_TARGET0_HI_S  0

#define SYSTIMER_TARGET0_LO_REG          (DR_REG_SYSTIMER_BASE + 0x20)
/* SYSTIMER_TIMER_TARGET0_LO : R/W ;bitpos:[31:0] ;default: 32'd0 ; */
/*description: Configures the alarm value to be loaded to COMP0, low 32 bits..*/
...
/* SYSTIMER_TIMER_TARGET1_HI : R/W ;bitpos:[19:0] ;default: 20'd0 ; */
/*description: Configures the alarm value to be loaded to COMP1, high 20 bits..*/
...
#define SYSTIMER_TIMER_TARGET1_HI_V  0xFFFFF
#define SYSTIMER_TIMER_TARGET1_HI_S  0

#define SYSTIMER_TARGET1_LO_REG          (DR_REG_SYSTIMER_BASE + 0x28)
/* SYSTIMER_TIMER_TARGET1_LO : R/W ;bitpos:[31:0] ;default: 32'd0 ; */
/*description: Configures the alarm value to be loaded to COMP1, low 32 bits..*/
...
/* SYSTIMER_TIMER_TARGET2_HI : R/W ;bitpos:[19:0] ;default: 20'd0 ; */
/*description: Configures the alarm value to be loaded to COMP2, high 20 bits..*/
...
#define SYSTIMER_TIMER_TARGET2_HI_V  0xFFFFF
#define SYSTIMER_TIMER_TARGET2_HI_S  0

#define SYSTIMER_TARGET2_LO_REG          (DR_REG_SYSTIMER_BASE + 0x30)
/* SYSTIMER_TIMER_TARGET2_LO : R/W ;bitpos:[31:0] ;default: 32'd0 ; */
/*description: Configures the alarm value to be loaded to COMP2, low 32 bits..*/
...
/*description: Chooses the counter value for comparison with COMP0.\\; 0: Use the count value f
rom UNIT$0\\; 1: Use the count value from UNIT$1\\.*/
...
/*description: Selects the two alarm modes for COMP0. \\; 0: Target mode\\; 1: Period mode\\.*/
...
/*description: Configures COMP0 alarm period..*/
...
/*description: Chooses the counter value for comparison with COMP1. See details in SYSTIMER_TAR
GET0_TIMER_UNIT_SEL..*/
...
/*description: Selects the two alarm modes for COMP1. See details in SYSTIMER_TARGET0_PERIOD_MO
DE..*/
...
/*description: Configures COMP1 alarm period..*/
...
/*description: Chooses the counter value for comparison with COMP2. See details in SYSTIMER_TAR
GET0_TIMER_UNIT_SEL..*/
...
/*description: Configures Configures the two alarm modes for COMP2. See details in SYSTIMER_TAR
GET0_PERIOD_MODE..*/
...
/*description: Configures COMP2 alarm period..*/
...
/* SYSTIMER_TIMER_UNIT0_VALUE_HI : RO ;bitpos:[19:0] ;default: 20'd0 ; */
/*description: Represents UNIT0 read value, high 20 bits..*/
...
#define SYSTIMER_TIMER_UNIT0_VALUE_HI_V  0xFFFFF
#define SYSTIMER_TIMER_UNIT0_VALUE_HI_S  0

#define SYSTIMER_UNIT0_VALUE_LO_REG          (DR_REG_SYSTIMER_BASE + 0x44)
/* SYSTIMER_TIMER_UNIT0_VALUE_LO : RO ;bitpos:[31:0] ;default: 32'd0 ; */
/*description: Represents UNIT0 read value, low 32 bits..*/
...
/* SYSTIMER_TIMER_UNIT1_VALUE_HI : RO ;bitpos:[19:0] ;default: 20'd0 ; */
/*description: Represents UNIT1 read value, high 20 bits..*/
...
#define SYSTIMER_TIMER_UNIT1_VALUE_HI_V  0xFFFFF
#define SYSTIMER_TIMER_UNIT1_VALUE_HI_S  0

#define SYSTIMER_UNIT1_VALUE_LO_REG          (DR_REG_SYSTIMER_BASE + 0x4C)
/* SYSTIMER_TIMER_UNIT1_VALUE_LO : RO ;bitpos:[31:0] ;default: 32'd0 ; */
/*description: Represents UNIT1 read value, low 32 bits..*/
...
/* SYSTIMER_TIMER_COMP0_LOAD : WT ;bitpos:[0] ;default: 1'b0 ; */
/*description: Configures whether or not to enable COMP0 synchronization, i.e., reload the alar
m value/period to COMP0.\\; 0: No effect \\; 1: Enable COMP0 synchronization\\;
.*/
#define SYSTIMER_TIMER_COMP0_LOAD    (BIT(0))
#define SYSTIMER_TIMER_COMP0_LOAD_M  (BIT(0))
#define SYSTIMER_TIMER_COMP0_LOAD_V  0x1
#define SYSTIMER_TIMER_COMP0_LOAD_S  0

#define SYSTIMER_COMP1_LOAD_REG          (DR_REG_SYSTIMER_BASE + 0x54)
/* SYSTIMER_TIMER_COMP1_LOAD : WT ;bitpos:[0] ;default: 1'b0 ; */
/*description: Configures whether or not to enable COMP1 synchronization, i.e., reload the alar
m value/period to COMP1. \\; 0: No effect \\; 1: Enable COMP1 synchronization\\.*/
#define SYSTIMER_TIMER_COMP1_LOAD    (BIT(0))
#define SYSTIMER_TIMER_COMP1_LOAD_M  (BIT(0))
#define SYSTIMER_TIMER_COMP1_LOAD_V  0x1
#define SYSTIMER_TIMER_COMP1_LOAD_S  0

#define SYSTIMER_COMP2_LOAD_REG          (DR_REG_SYSTIMER_BASE + 0x58)
/* SYSTIMER_TIMER_COMP2_LOAD : WT ;bitpos:[0] ;default: 1'b0 ; */
/*description: Configures whether or not to enable COMP2 synchronization, i.e., reload the alar
m value/period to COMP2.\\; 0: No effect \\; 1: Enable COMP2 synchronization\\.*/
#define SYSTIMER_TIMER_COMP2_LOAD    (BIT(0))
#define SYSTIMER_TIMER_COMP2_LOAD_M  (BIT(0))
#define SYSTIMER_TIMER_COMP2_LOAD_V  0x1
#define SYSTIMER_TIMER_COMP2_LOAD_S  0

#define SYSTIMER_UNIT0_LOAD_REG          (DR_REG_SYSTIMER_BASE + 0x5C)
/* SYSTIMER_TIMER_UNIT0_LOAD : WT ;bitpos:[0] ;default: 1'b0 ; */
/*description: Configures whether or not to reload the value of UNIT0, i.e., reloads the values
 of SYSTIMER_TIMER_UNIT0_VALUE_HI and SYSTIMER_TIMER_UNIT0_VALUE_LO to UNIT0. \\
; 0: No effect \\; 1: Reload the value of UNIT0\\.*/
#define SYSTIMER_TIMER_UNIT0_LOAD    (BIT(0))
#define SYSTIMER_TIMER_UNIT0_LOAD_M  (BIT(0))
#define SYSTIMER_TIMER_UNIT0_LOAD_V  0x1
#define SYSTIMER_TIMER_UNIT0_LOAD_S  0

#define SYSTIMER_UNIT1_LOAD_REG          (DR_REG_SYSTIMER_BASE + 0x60)
/* SYSTIMER_TIMER_UNIT1_LOAD : WT ;bitpos:[0] ;default: 1'b0 ; */
/*description: Configures whether or not to reload the value of UNIT1, i.e., reload the values
of SYSTIMER_TIMER_UNIT1_VALUE_HI and SYSTIMER_TIMER_UNIT1_VALUE_LO to UNIT1. \\;
 0: No effect \\; 1: Reload the value of UNIT1\\.*/
#define SYSTIMER_TIMER_UNIT1_LOAD    (BIT(0))
#define SYSTIMER_TIMER_UNIT1_LOAD_M  (BIT(0))
#define SYSTIMER_TIMER_UNIT1_LOAD_V  0x1
...
/*description: Write 1 to enable SYSTIMER_TARGET2_INT..*/
...
/*description: Write 1 to enable SYSTIMER_TARGET1_INT..*/
...
/*description: Write 1 to enable SYSTIMER_TARGET0_INT..*/
...
/*description: The raw interrupt status of SYSTIMER_TARGET2_INT..*/
...
/*description: The raw interrupt status of SYSTIMER_TARGET1_INT..*/
...
/*description: The raw interrupt status of SYSTIMER_TARGET0_INT..*/
...
/*description: Write 1 to clear SYSTIMER_TARGET2_INT..*/
...
/*description: Write 1 to clear SYSTIMER_TARGET1_INT..*/
...
/*description: Write 1 to clear SYSTIMER_TARGET0_INT..*/
...
/*description: The interrupt status of SYSTIMER_TARGET2_INT..*/
...
/*description: The interrupt status of SYSTIMER_TARGET1_INT..*/
...
/*description: The interrupt status of SYSTIMER_TARGET0_INT..*/
...
/* SYSTIMER_TARGET0_LO_RO : RO ;bitpos:[31:0] ;default: 32'd0 ; */
/*description: Represents the actual target value of COMP0, low 32 bits..*/
...
/* SYSTIMER_TARGET0_HI_RO : RO ;bitpos:[19:0] ;default: 20'd0 ; */
/*description: Represents the actual target value of COMP0, high 20 bits..*/
...
#define SYSTIMER_TARGET0_HI_RO_V  0xFFFFF
#define SYSTIMER_TARGET0_HI_RO_S  0

#define SYSTIMER_REAL_TARGET1_LO_REG          (DR_REG_SYSTIMER_BASE + 0x7C)
/* SYSTIMER_TARGET1_LO_RO : RO ;bitpos:[31:0] ;default: 32'd0 ; */
/*description: Represents the actual target value of COMP1, low 32 bits..*/
...
/* SYSTIMER_TARGET1_HI_RO : RO ;bitpos:[19:0] ;default: 20'd0 ; */
/*description: Represents the actual target value of COMP1, high 20 bits..*/
...
#define SYSTIMER_TARGET1_HI_RO_V  0xFFFFF
#define SYSTIMER_TARGET1_HI_RO_S  0

#define SYSTIMER_REAL_TARGET2_LO_REG          (DR_REG_SYSTIMER_BASE + 0x84)
/* SYSTIMER_TARGET2_LO_RO : RO ;bitpos:[31:0] ;default: 32'd0 ; */
/*description: Represents the actual target value of COMP2, low 32 bits..*/
...
/* SYSTIMER_TARGET2_HI_RO : RO ;bitpos:[19:0] ;default: 20'd0 ; */
/*description: Represents the actual target value of COMP2, high 20 bits..*/
...
#define SYSTIMER_TARGET2_HI_RO_V  0xFFFFF
#define SYSTIMER_TARGET2_HI_RO_S  0

#define SYSTIMER_DATE_REG          (DR_REG_SYSTIMER_BASE + 0xFC)
/* SYSTIMER_DATE : R/W ;bitpos:[31:0] ;default: 28'h2312220 ; */
