...
/* USB_DEVICE_RDWR_BYTE : RO ;bitpos:[7:0] ;default: 8'h0 ; */
...
/* USB_DEVICE_SET_LINE_CODE_INT_RAW : R/WTC/SS ;bitpos:[15] ;default: 1'b0 ; */
/*description: The raw interrupt bit turns to high level when level of SET LINE CODING request
is received..*/
#define USB_DEVICE_SET_LINE_CODE_INT_RAW    (BIT(15))
#define USB_DEVICE_SET_LINE_CODE_INT_RAW_M  (BIT(15))
#define USB_DEVICE_SET_LINE_CODE_INT_RAW_V  0x1
#define USB_DEVICE_SET_LINE_CODE_INT_RAW_S  15
/* USB_DEVICE_GET_LINE_CODE_INT_RAW : R/WTC/SS ;bitpos:[14] ;default: 1'b0 ; */
/*description: The raw interrupt bit turns to high level when level of GET LINE CODING request
is received..*/
#define USB_DEVICE_GET_LINE_CODE_INT_RAW    (BIT(14))
#define USB_DEVICE_GET_LINE_CODE_INT_RAW_M  (BIT(14))
#define USB_DEVICE_GET_LINE_CODE_INT_RAW_V  0x1
#define USB_DEVICE_GET_LINE_CODE_INT_RAW_S  14
/* USB_DEVICE_DTR_CHG_INT_RAW : R/WTC/SS ;bitpos:[13] ;default: 1'b0 ; */
/*description: The raw interrupt bit turns to high level when level of DTR from usb serial chan
nel is changed..*/
#define USB_DEVICE_DTR_CHG_INT_RAW    (BIT(13))
#define USB_DEVICE_DTR_CHG_INT_RAW_M  (BIT(13))
#define USB_DEVICE_DTR_CHG_INT_RAW_V  0x1
#define USB_DEVICE_DTR_CHG_INT_RAW_S  13
/* USB_DEVICE_RTS_CHG_INT_RAW : R/WTC/SS ;bitpos:[12] ;default: 1'b0 ; */
/*description: The raw interrupt bit turns to high level when level of RTS from usb serial chan
nel is changed..*/
#define USB_DEVICE_RTS_CHG_INT_RAW    (BIT(12))
#define USB_DEVICE_RTS_CHG_INT_RAW_M  (BIT(12))
#define USB_DEVICE_RTS_CHG_INT_RAW_V  0x1
#define USB_DEVICE_RTS_CHG_INT_RAW_S  12
...
/* USB_DEVICE_SET_LINE_CODE_INT_ST : RO ;bitpos:[15] ;default: 1'b0 ; */
/*description: The raw interrupt status bit for the USB_DEVICE_SET_LINE_CODE_INT interrupt..*/
#define USB_DEVICE_SET_LINE_CODE_INT_ST    (BIT(15))
#define USB_DEVICE_SET_LINE_CODE_INT_ST_M  (BIT(15))
#define USB_DEVICE_SET_LINE_CODE_INT_ST_V  0x1
#define USB_DEVICE_SET_LINE_CODE_INT_ST_S  15
/* USB_DEVICE_GET_LINE_CODE_INT_ST : RO ;bitpos:[14] ;default: 1'b0 ; */
/*description: The raw interrupt status bit for the USB_DEVICE_GET_LINE_CODE_INT interrupt..*/
#define USB_DEVICE_GET_LINE_CODE_INT_ST    (BIT(14))
#define USB_DEVICE_GET_LINE_CODE_INT_ST_M  (BIT(14))
#define USB_DEVICE_GET_LINE_CODE_INT_ST_V  0x1
#define USB_DEVICE_GET_LINE_CODE_INT_ST_S  14
/* USB_DEVICE_DTR_CHG_INT_ST : RO ;bitpos:[13] ;default: 1'b0 ; */
/*description: The raw interrupt status bit for the USB_DEVICE_DTR_CHG_INT interrupt..*/
#define USB_DEVICE_DTR_CHG_INT_ST    (BIT(13))
#define USB_DEVICE_DTR_CHG_INT_ST_M  (BIT(13))
#define USB_DEVICE_DTR_CHG_INT_ST_V  0x1
#define USB_DEVICE_DTR_CHG_INT_ST_S  13
/* USB_DEVICE_RTS_CHG_INT_ST : RO ;bitpos:[12] ;default: 1'b0 ; */
/*description: The raw interrupt status bit for the USB_DEVICE_RTS_CHG_INT interrupt..*/
#define USB_DEVICE_RTS_CHG_INT_ST    (BIT(12))
#define USB_DEVICE_RTS_CHG_INT_ST_M  (BIT(12))
#define USB_DEVICE_RTS_CHG_INT_ST_V  0x1
#define USB_DEVICE_RTS_CHG_INT_ST_S  12
...
/* USB_DEVICE_SET_LINE_CODE_INT_ENA : R/W ;bitpos:[15] ;default: 1'b0 ; */
/*description: The interrupt enable bit for the USB_DEVICE_SET_LINE_CODE_INT interrupt..*/
#define USB_DEVICE_SET_LINE_CODE_INT_ENA    (BIT(15))
#define USB_DEVICE_SET_LINE_CODE_INT_ENA_M  (BIT(15))
#define USB_DEVICE_SET_LINE_CODE_INT_ENA_V  0x1
#define USB_DEVICE_SET_LINE_CODE_INT_ENA_S  15
/* USB_DEVICE_GET_LINE_CODE_INT_ENA : R/W ;bitpos:[14] ;default: 1'b0 ; */
/*description: The interrupt enable bit for the USB_DEVICE_GET_LINE_CODE_INT interrupt..*/
#define USB_DEVICE_GET_LINE_CODE_INT_ENA    (BIT(14))
#define USB_DEVICE_GET_LINE_CODE_INT_ENA_M  (BIT(14))
#define USB_DEVICE_GET_LINE_CODE_INT_ENA_V  0x1
#define USB_DEVICE_GET_LINE_CODE_INT_ENA_S  14
/* USB_DEVICE_DTR_CHG_INT_ENA : R/W ;bitpos:[13] ;default: 1'b0 ; */
/*description: The interrupt enable bit for the USB_DEVICE_DTR_CHG_INT interrupt..*/
#define USB_DEVICE_DTR_CHG_INT_ENA    (BIT(13))
#define USB_DEVICE_DTR_CHG_INT_ENA_M  (BIT(13))
#define USB_DEVICE_DTR_CHG_INT_ENA_V  0x1
#define USB_DEVICE_DTR_CHG_INT_ENA_S  13
/* USB_DEVICE_RTS_CHG_INT_ENA : R/W ;bitpos:[12] ;default: 1'b0 ; */
/*description: The interrupt enable bit for the USB_DEVICE_RTS_CHG_INT interrupt..*/
#define USB_DEVICE_RTS_CHG_INT_ENA    (BIT(12))
#define USB_DEVICE_RTS_CHG_INT_ENA_M  (BIT(12))
#define USB_DEVICE_RTS_CHG_INT_ENA_V  0x1
#define USB_DEVICE_RTS_CHG_INT_ENA_S  12
...
/* USB_DEVICE_SET_LINE_CODE_INT_CLR : WT ;bitpos:[15] ;default: 1'b0 ; */
/*description: Set this bit to clear the USB_DEVICE_SET_LINE_CODE_INT interrupt..*/
#define USB_DEVICE_SET_LINE_CODE_INT_CLR    (BIT(15))
#define USB_DEVICE_SET_LINE_CODE_INT_CLR_M  (BIT(15))
#define USB_DEVICE_SET_LINE_CODE_INT_CLR_V  0x1
#define USB_DEVICE_SET_LINE_CODE_INT_CLR_S  15
/* USB_DEVICE_GET_LINE_CODE_INT_CLR : WT ;bitpos:[14] ;default: 1'b0 ; */
/*description: Set this bit to clear the USB_DEVICE_GET_LINE_CODE_INT interrupt..*/
#define USB_DEVICE_GET_LINE_CODE_INT_CLR    (BIT(14))
#define USB_DEVICE_GET_LINE_CODE_INT_CLR_M  (BIT(14))
#define USB_DEVICE_GET_LINE_CODE_INT_CLR_V  0x1
#define USB_DEVICE_GET_LINE_CODE_INT_CLR_S  14
/* USB_DEVICE_DTR_CHG_INT_CLR : WT ;bitpos:[13] ;default: 1'b0 ; */
/*description: Set this bit to clear the USB_DEVICE_DTR_CHG_INT interrupt..*/
#define USB_DEVICE_DTR_CHG_INT_CLR    (BIT(13))
#define USB_DEVICE_DTR_CHG_INT_CLR_M  (BIT(13))
#define USB_DEVICE_DTR_CHG_INT_CLR_V  0x1
#define USB_DEVICE_DTR_CHG_INT_CLR_S  13
/* USB_DEVICE_RTS_CHG_INT_CLR : WT ;bitpos:[12] ;default: 1'b0 ; */
/*description: Set this bit to clear the USB_DEVICE_RTS_CHG_INT interrupt..*/
#define USB_DEVICE_RTS_CHG_INT_CLR    (BIT(12))
#define USB_DEVICE_RTS_CHG_INT_CLR_M  (BIT(12))
#define USB_DEVICE_RTS_CHG_INT_CLR_V  0x1
#define USB_DEVICE_RTS_CHG_INT_CLR_S  12
...
/* USB_DEVICE_USB_JTAG_BRIDGE_EN : R/W ;bitpos:[15] ;default: 1'b0 ; */
...
ough GPIO Matrix..*/
#define USB_DEVICE_USB_JTAG_BRIDGE_EN    (BIT(15))
#define USB_DEVICE_USB_JTAG_BRIDGE_EN_M  (BIT(15))
#define USB_DEVICE_USB_JTAG_BRIDGE_EN_V  0x1
#define USB_DEVICE_USB_JTAG_BRIDGE_EN_S  15
...
/* USB_DEVICE_TEST_RX_DP : RO ;bitpos:[5] ;default: 1'b1 ; */
/*description: USB D+ rx value in test.*/
...
/* USB_DEVICE_TEST_RX_RCV : RO ;bitpos:[4] ;default: 1'b1 ; */
...
#define USB_DEVICE_CHIP_RST_REG          (DR_REG_USB_DEVICE_BASE + 0x4C)
/* USB_DEVICE_USB_UART_CHIP_RST_DIS : R/W ;bitpos:[2] ;default: 1'b0 ; */
/*description: Set this bit to disable chip reset from usb serial channel to reset chip..*/
#define USB_DEVICE_USB_UART_CHIP_RST_DIS    (BIT(2))
#define USB_DEVICE_USB_UART_CHIP_RST_DIS_M  (BIT(2))
#define USB_DEVICE_USB_UART_CHIP_RST_DIS_V  0x1
#define USB_DEVICE_USB_UART_CHIP_RST_DIS_S  2
/* USB_DEVICE_DTR : RO ;bitpos:[1] ;default: 1'b0 ; */
/*description: 1: Chip reset is detected from usb jtag channel. Software write 1 to clear it..*/
#define USB_DEVICE_DTR    (BIT(1))
#define USB_DEVICE_DTR_M  (BIT(1))
#define USB_DEVICE_DTR_V  0x1
#define USB_DEVICE_DTR_S  1
/* USB_DEVICE_RTS : RO ;bitpos:[0] ;default: 1'b0 ; */
/*description: 1: Chip reset is detected from usb serial channel. Software write 1 to clear it..*/
#define USB_DEVICE_RTS    (BIT(0))
#define USB_DEVICE_RTS_M  (BIT(0))
#define USB_DEVICE_RTS_V  0x1
#define USB_DEVICE_RTS_S  0

#define USB_DEVICE_SET_LINE_CODE_W0_REG          (DR_REG_USB_DEVICE_BASE + 0x50)
/* USB_DEVICE_DW_DTE_RATE : RO ;bitpos:[31:0] ;default: 32'd0 ; */
/*description: The value of dwDTERate set by host through SET_LINE_CODING command..*/
#define USB_DEVICE_DW_DTE_RATE    0xFFFFFFFF
#define USB_DEVICE_DW_DTE_RATE_M  ((USB_DEVICE_DW_DTE_RATE_V)<<(USB_DEVICE_DW_DTE_RATE_S))
#define USB_DEVICE_DW_DTE_RATE_V  0xFFFFFFFF
#define USB_DEVICE_DW_DTE_RATE_S  0

#define USB_DEVICE_SET_LINE_CODE_W1_REG          (DR_REG_USB_DEVICE_BASE + 0x54)
/* USB_DEVICE_BDATA_BITS : RO ;bitpos:[23:16] ;default: 8'd0 ; */
/*description: The value of bDataBits set by host through SET_LINE_CODING command..*/
#define USB_DEVICE_BDATA_BITS    0x000000FF
#define USB_DEVICE_BDATA_BITS_M  ((USB_DEVICE_BDATA_BITS_V)<<(USB_DEVICE_BDATA_BITS_S))
#define USB_DEVICE_BDATA_BITS_V  0xFF
#define USB_DEVICE_BDATA_BITS_S  16
/* USB_DEVICE_BPARITY_TYPE : RO ;bitpos:[15:8] ;default: 8'd0 ; */
/*description: The value of bParityTpye set by host through SET_LINE_CODING command..*/
#define USB_DEVICE_BPARITY_TYPE    0x000000FF
#define USB_DEVICE_BPARITY_TYPE_M  ((USB_DEVICE_BPARITY_TYPE_V)<<(USB_DEVICE_BPARITY_TYPE_S))
#define USB_DEVICE_BPARITY_TYPE_V  0xFF
#define USB_DEVICE_BPARITY_TYPE_S  8
/* USB_DEVICE_BCHAR_FORMAT : RO ;bitpos:[7:0] ;default: 8'd0 ; */
/*description: The value of bCharFormat set by host through SET_LINE_CODING command..*/
#define USB_DEVICE_BCHAR_FORMAT    0x000000FF
#define USB_DEVICE_BCHAR_FORMAT_M  ((USB_DEVICE_BCHAR_FORMAT_V)<<(USB_DEVICE_BCHAR_FORMAT_S))
#define USB_DEVICE_BCHAR_FORMAT_V  0xFF
#define USB_DEVICE_BCHAR_FORMAT_S  0

#define USB_DEVICE_GET_LINE_CODE_W0_REG          (DR_REG_USB_DEVICE_BASE + 0x58)
/* USB_DEVICE_GET_DW_DTE_RATE : R/W ;bitpos:[31:0] ;default: 32'd0 ; */
/*description: The value of dwDTERate set by software which is requested by GET_LINE_CODING com
mand..*/
#define USB_DEVICE_GET_DW_DTE_RATE    0xFFFFFFFF
#define USB_DEVICE_GET_DW_DTE_RATE_M  ((USB_DEVICE_GET_DW_DTE_RATE_V)<<(USB_DEVICE_GET_DW_DTE_RATE_S))
#define USB_DEVICE_GET_DW_DTE_RATE_V  0xFFFFFFFF
#define USB_DEVICE_GET_DW_DTE_RATE_S  0

#define USB_DEVICE_GET_LINE_CODE_W1_REG          (DR_REG_USB_DEVICE_BASE + 0x5C)
/* USB_DEVICE_GET_BCHAR_FORMAT : R/W ;bitpos:[23:16] ;default: 8'd0 ; */
/*description: The value of bDataBits set by software which is requested by GET_LINE_CODING com
mand..*/
#define USB_DEVICE_GET_BCHAR_FORMAT    0x000000FF
#define USB_DEVICE_GET_BCHAR_FORMAT_M  ((USB_DEVICE_GET_BCHAR_FORMAT_V)<<(USB_DEVICE_GET_BCHAR_FORMAT_S))
#define USB_DEVICE_GET_BCHAR_FORMAT_V  0xFF
#define USB_DEVICE_GET_BCHAR_FORMAT_S  16
/* USB_DEVICE_GET_BPARITY_TYPE : R/W ;bitpos:[15:8] ;default: 8'd0 ; */
/*description: The value of bParityTpye set by software which is requested by GET_LINE_CODING c
ommand..*/
#define USB_DEVICE_GET_BPARITY_TYPE    0x000000FF
#define USB_DEVICE_GET_BPARITY_TYPE_M  ((USB_DEVICE_GET_BPARITY_TYPE_V)<<(USB_DEVICE_GET_BPARITY_TYPE_S))
#define USB_DEVICE_GET_BPARITY_TYPE_V  0xFF
#define USB_DEVICE_GET_BPARITY_TYPE_S  8
/* USB_DEVICE_GET_BDATA_BITS : R/W ;bitpos:[7:0] ;default: 8'd0 ; */
/*description: The value of bCharFormat set by software which is requested by GET_LINE_CODING c
ommand..*/
#define USB_DEVICE_GET_BDATA_BITS    0x000000FF
#define USB_DEVICE_GET_BDATA_BITS_M  ((USB_DEVICE_GET_BDATA_BITS_V)<<(USB_DEVICE_GET_BDATA_BITS_S))
#define USB_DEVICE_GET_BDATA_BITS_V  0xFF
#define USB_DEVICE_GET_BDATA_BITS_S  0

#define USB_DEVICE_CONFIG_UPDATE_REG          (DR_REG_USB_DEVICE_BASE + 0x60)
/* USB_DEVICE_CONFIG_UPDATE : WT ;bitpos:[0] ;default: 1'b0 ; */
/*description: Write 1 to this register would update the value of configure registers from APB
clock domain to 48MHz clock domain..*/
#define USB_DEVICE_CONFIG_UPDATE    (BIT(0))
#define USB_DEVICE_CONFIG_UPDATE_M  (BIT(0))
#define USB_DEVICE_CONFIG_UPDATE_V  0x1
#define USB_DEVICE_CONFIG_UPDATE_S  0

#define USB_DEVICE_SER_AFIFO_CONFIG_REG          (DR_REG_USB_DEVICE_BASE + 0x64)
/* USB_DEVICE_SERIAL_IN_AFIFO_WFULL : RO ;bitpos:[5] ;default: 1'b0 ; */
/*description: CDC_ACM OUT IN async FIFO empty signal in write clock domain..*/
#define USB_DEVICE_SERIAL_IN_AFIFO_WFULL    (BIT(5))
#define USB_DEVICE_SERIAL_IN_AFIFO_WFULL_M  (BIT(5))
#define USB_DEVICE_SERIAL_IN_AFIFO_WFULL_V  0x1
#define USB_DEVICE_SERIAL_IN_AFIFO_WFULL_S  5
/* USB_DEVICE_SERIAL_OUT_AFIFO_REMPTY : RO ;bitpos:[4] ;default: 1'b1 ; */
/*description: CDC_ACM OUTOUT async FIFO empty signal in read clock domain..*/
#define USB_DEVICE_SERIAL_OUT_AFIFO_REMPTY    (BIT(4))
#define USB_DEVICE_SERIAL_OUT_AFIFO_REMPTY_M  (BIT(4))
#define USB_DEVICE_SERIAL_OUT_AFIFO_REMPTY_V  0x1
#define USB_DEVICE_SERIAL_OUT_AFIFO_REMPTY_S  4
/* USB_DEVICE_SERIAL_OUT_AFIFO_RESET_RD : R/W ;bitpos:[3] ;default: 1'b0 ; */
/*description: Write 1 to reset CDC_ACM OUT async FIFO read clock domain..*/
#define USB_DEVICE_SERIAL_OUT_AFIFO_RESET_RD    (BIT(3))
#define USB_DEVICE_SERIAL_OUT_AFIFO_RESET_RD_M  (BIT(3))
#define USB_DEVICE_SERIAL_OUT_AFIFO_RESET_RD_V  0x1
#define USB_DEVICE_SERIAL_OUT_AFIFO_RESET_RD_S  3
/* USB_DEVICE_SERIAL_OUT_AFIFO_RESET_WR : R/W ;bitpos:[2] ;default: 1'b0 ; */
/*description: Write 1 to reset CDC_ACM OUT async FIFO write clock domain..*/
#define USB_DEVICE_SERIAL_OUT_AFIFO_RESET_WR    (BIT(2))
#define USB_DEVICE_SERIAL_OUT_AFIFO_RESET_WR_M  (BIT(2))
#define USB_DEVICE_SERIAL_OUT_AFIFO_RESET_WR_V  0x1
#define USB_DEVICE_SERIAL_OUT_AFIFO_RESET_WR_S  2
/* USB_DEVICE_SERIAL_IN_AFIFO_RESET_RD : R/W ;bitpos:[1] ;default: 1'b0 ; */
/*description: Write 1 to reset CDC_ACM IN async FIFO read clock domain..*/
#define USB_DEVICE_SERIAL_IN_AFIFO_RESET_RD    (BIT(1))
#define USB_DEVICE_SERIAL_IN_AFIFO_RESET_RD_M  (BIT(1))
#define USB_DEVICE_SERIAL_IN_AFIFO_RESET_RD_V  0x1
#define USB_DEVICE_SERIAL_IN_AFIFO_RESET_RD_S  1
/* USB_DEVICE_SERIAL_IN_AFIFO_RESET_WR : R/W ;bitpos:[0] ;default: 1'b0 ; */
/*description: Write 1 to reset CDC_ACM IN async FIFO write clock domain..*/
#define USB_DEVICE_SERIAL_IN_AFIFO_RESET_WR    (BIT(0))
#define USB_DEVICE_SERIAL_IN_AFIFO_RESET_WR_M  (BIT(0))
#define USB_DEVICE_SERIAL_IN_AFIFO_RESET_WR_V  0x1
#define USB_DEVICE_SERIAL_IN_AFIFO_RESET_WR_S  0

#define USB_DEVICE_BUS_RESET_ST_REG          (DR_REG_USB_DEVICE_BASE + 0x68)
/* USB_DEVICE_USB_BUS_RESET_ST : RO ;bitpos:[0] ;default: 1'b1 ; */
/*description: USB bus reset status. 0: USB-Serial-JTAG is in usb bus reset status. 1: USB bus
reset is released..*/
#define USB_DEVICE_USB_BUS_RESET_ST    (BIT(0))
#define USB_DEVICE_USB_BUS_RESET_ST_M  (BIT(0))
#define USB_DEVICE_USB_BUS_RESET_ST_V  0x1
#define USB_DEVICE_USB_BUS_RESET_ST_S  0

#define USB_DEVICE_ECO_LOW_48_REG          (DR_REG_USB_DEVICE_BASE + 0x6C)
/* USB_DEVICE_RND_ECO_LOW_48 : R/W ;bitpos:[31:0] ;default: 32'h0 ; */
/*description: Reserved..*/
#define USB_DEVICE_RND_ECO_LOW_48    0xFFFFFFFF
#define USB_DEVICE_RND_ECO_LOW_48_M  ((USB_DEVICE_RND_ECO_LOW_48_V)<<(USB_DEVICE_RND_ECO_LOW_48_S))
#define USB_DEVICE_RND_ECO_LOW_48_V  0xFFFFFFFF
#define USB_DEVICE_RND_ECO_LOW_48_S  0

#define USB_DEVICE_ECO_HIGH_48_REG          (DR_REG_USB_DEVICE_BASE + 0x70)
/* USB_DEVICE_RND_ECO_HIGH_48 : R/W ;bitpos:[31:0] ;default: 32'hffffffff ; */
/*description: Reserved..*/
#define USB_DEVICE_RND_ECO_HIGH_48    0xFFFFFFFF
#define USB_DEVICE_RND_ECO_HIGH_48_M  ((USB_DEVICE_RND_ECO_HIGH_48_V)<<(USB_DEVICE_RND_ECO_HIGH_48_S))
#define USB_DEVICE_RND_ECO_HIGH_48_V  0xFFFFFFFF
#define USB_DEVICE_RND_ECO_HIGH_48_S  0

#define USB_DEVICE_ECO_CELL_CTRL_48_REG          (DR_REG_USB_DEVICE_BASE + 0x74)
/* USB_DEVICE_RDN_ENA_48 : R/W ;bitpos:[1] ;default: 1'b0 ; */
/*description: Reserved..*/
#define USB_DEVICE_RDN_ENA_48    (BIT(1))
#define USB_DEVICE_RDN_ENA_48_M  (BIT(1))
#define USB_DEVICE_RDN_ENA_48_V  0x1
#define USB_DEVICE_RDN_ENA_48_S  1
/* USB_DEVICE_RDN_RESULT_48 : RO ;bitpos:[0] ;default: 1'b0 ; */
/*description: Reserved..*/
#define USB_DEVICE_RDN_RESULT_48    (BIT(0))
#define USB_DEVICE_RDN_RESULT_48_M  (BIT(0))
#define USB_DEVICE_RDN_RESULT_48_V  0x1
#define USB_DEVICE_RDN_RESULT_48_S  0

#define USB_DEVICE_ECO_LOW_APB_REG          (DR_REG_USB_DEVICE_BASE + 0x78)
/* USB_DEVICE_RND_ECO_LOW_APB : R/W ;bitpos:[31:0] ;default: 32'h0 ; */
/*description: Reserved..*/
#define USB_DEVICE_RND_ECO_LOW_APB    0xFFFFFFFF
#define USB_DEVICE_RND_ECO_LOW_APB_M  ((USB_DEVICE_RND_ECO_LOW_APB_V)<<(USB_DEVICE_RND_ECO_LOW_APB_S))
#define USB_DEVICE_RND_ECO_LOW_APB_V  0xFFFFFFFF
#define USB_DEVICE_RND_ECO_LOW_APB_S  0

#define USB_DEVICE_ECO_HIGH_APB_REG          (DR_REG_USB_DEVICE_BASE + 0x7C)
/* USB_DEVICE_RND_ECO_HIGH_APB : R/W ;bitpos:[31:0] ;default: 32'hffffffff ; */
/*description: Reserved..*/
#define USB_DEVICE_RND_ECO_HIGH_APB    0xFFFFFFFF
#define USB_DEVICE_RND_ECO_HIGH_APB_M  ((USB_DEVICE_RND_ECO_HIGH_APB_V)<<(USB_DEVICE_RND_ECO_HIGH_APB_S))
#define USB_DEVICE_RND_ECO_HIGH_APB_V  0xFFFFFFFF
#define USB_DEVICE_RND_ECO_HIGH_APB_S  0

#define USB_DEVICE_ECO_CELL_CTRL_APB_REG          (DR_REG_USB_DEVICE_BASE + 0x80)
/* USB_DEVICE_RDN_ENA_APB : R/W ;bitpos:[1] ;default: 1'b0 ; */
/*description: Reserved..*/
#define USB_DEVICE_RDN_ENA_APB    (BIT(1))
#define USB_DEVICE_RDN_ENA_APB_M  (BIT(1))
#define USB_DEVICE_RDN_ENA_APB_V  0x1
#define USB_DEVICE_RDN_ENA_APB_S  1
/* USB_DEVICE_RDN_RESULT_APB : RO ;bitpos:[0] ;default: 1'b0 ; */
/*description: Reserved..*/
#define USB_DEVICE_RDN_RESULT_APB    (BIT(0))
#define USB_DEVICE_RDN_RESULT_APB_M  (BIT(0))
#define USB_DEVICE_RDN_RESULT_APB_V  0x1
#define USB_DEVICE_RDN_RESULT_APB_S  0

#define USB_DEVICE_SRAM_CTRL_REG          (DR_REG_USB_DEVICE_BASE + 0x84)
/* USB_DEVICE_MEM_AUX_CTRL : R/W ;bitpos:[13:0] ;default: 14'h1320 ; */
/*description: Control signals.*/
#define USB_DEVICE_MEM_AUX_CTRL    0x00003FFF
#define USB_DEVICE_MEM_AUX_CTRL_M  ((USB_DEVICE_MEM_AUX_CTRL_V)<<(USB_DEVICE_MEM_AUX_CTRL_S))
#define USB_DEVICE_MEM_AUX_CTRL_V  0x3FFF
#define USB_DEVICE_MEM_AUX_CTRL_S  0

#define USB_DEVICE_DATE_REG          (DR_REG_USB_DEVICE_BASE + 0x88)
/* USB_DEVICE_DATE : R/W ;bitpos:[31:0] ;default: 32'h2112010 ; */
