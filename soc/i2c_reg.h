...
/*description: Configures the low level width of the SCL Clock in master mode. \\; Measurement
unit: i2c_sclk \\.*/
...
/*description: Configures to support the 7 bit general call function.\\ ; 0: Not support \\; 1:
 Support \\.*/
...
/*description: Configures to check if the r/w bit of 10bit addressing consists with I2C protoco
l.\\; 0: Not check\\; 1: Check.*/
...
/*description: Configures to enable slave to send data automatically\\; 0: Disable\\; 1: Enable
 \\.*/
...
/*description: Configures this bit for synchronization.\\; 0: No effect \\; 1: Synchronize.*/
...
/*description: Configures to reset the SCL_FSM.\\; 0: No effect \\; 1: Reset.*/
...
/*description: Configures to enable I2C bus arbitration detection.\\; 0: No effect \\; 1: Enabl
e \\.*/
...
/*description: Configures whether to gate clock signal for registers.\\; 0: Support clock only
when registers are read or written to by software \\; 1: Force clock on for regi
sters \\.*/
...
/*description: Configures to control the storage order for received data.\\; 0: receive data fr
om the most significant bit \\ ; 1: receive data from the least significant bit
\\;.*/
...
/*description: Configures to control the sending order for data needing to be sent.\\ ; 0: send
 data from the most significant bit \\; 1: send data from the least significant
bit \\.*/
...
/*description: Configures whether the slave starts sending the data in txfifo.\\ ; 0: No effect
 \\; 1: Start.*/
...
/*description: Configures the module as an I2C Master or Slave.\\ ; 0: Slave \\; 1: Master \\.*/
...
/*description: Configures the ACK value that needs to be sent by master when the rx_fifo_cnt ha
s reached the threshold.\\.*/
...
/*description: Configures the sample mode for SDA.\\; 0: Sample SDA data on the SCL high level
...
/* I2C_SCL_FORCE_OUT : R/W ;bitpos:[1] ;default: 1'b0 ; */
/*description: Configures the SCL output mode.\\; 0: Open drain output \\ ; 1: Direct output \\.*/
#define I2C_SCL_FORCE_OUT    (BIT(1))
#define I2C_SCL_FORCE_OUT_M  (BIT(1))
#define I2C_SCL_FORCE_OUT_V  0x1
#define I2C_SCL_FORCE_OUT_S  1
/* I2C_SDA_FORCE_OUT : R/W ;bitpos:[0] ;default: 1'b0 ; */
/*description: Configures the SDA output mode.\\; 0: Open drain output \\ ; 1: Direct output \\.*/
...
/*description: Represents the states of the state machine used to produce SCL.\\; 0: Idle\\; 1:
 Start\\; 2: Negative edge\\; 3: Low\\; 4: Positive edge\\; 5: High\\; 6: Stop.*/
...
/*description: Represents the states of the I2C module state machine.\\ ; 0: Idle\\; 1: Address
 shift\\; 2: ACK address\\; 3: Rx data\\; 4: Tx data\\; 5: Send ACK\\; 6: Wait A
CK.*/
...
/*description: Represents the cause of SCL clocking stretching in slave mode.\\; 0: Stretching
SCL low when the master starts to read data.\\; 1: Stretching SCL low when I2C T
X FIFO is empty in slave mode.\\; 2: Stretching SCL low when I2C RX FIFO is full
 in slave mode..*/
...
/*description: Represents whether the address sent by the master is equal to the address of the
 slave.\\; Valid only when the module is configured as an I2C Slave.\\; 0: Not e
qual\\; 1: Equal\\.*/
...
/*description: Represents the I2C bus state.\\; 1: The I2C bus is busy transferring data\\ ; 0:
 The I2C bus is in idle state.\\.*/
...
/*description: Represents whether the I2C controller loses control of SCL line.\\; 0: No arbitr
ation lost\\; 1: Arbitration lost\\.*/
...
/*description: Represents the transfer direction in slave mode.\\; 1: Master reads from slave\\
...
/*description: Represents the received ACK value in master mode or slave mode.\\; 0: ACK\\; 1:
NACK..*/
...
/*description: Configures to enable time out control.\\; 0: No effect \\; 1: Enable \\.*/
...
/*description: Configures the timeout threshold period for SCL stucking at high or low level. T
he actual period is 2\^{}(reg_time_out_value).\\; Measurement unit: i2c_sclk \\.*/
...
/*description: Configures to enable the slave 10-bit addressing mode in master mode.\\ ; 0: No
effect \\; 1: Enable \\.*/
...
/*description: Represents the offset address in the I2C Slave RAM addressed by I2C Master when
in I2C slave mode..*/
...
/*description: Configures to enable FIFO pointer in non-fifo access mode. This bit controls the
...
/*description: Configures to reset TXFIFO.\\; 0: No effect \\; 1: Reset.*/
...
/*description: Configures to reset RXFIFO.\\; 0: No effect \\; 1: Reset.*/
...
/*description: Configures the slave to enable dual address mode. When this mode is enabled, the
 byte received after the I2C address byte represents the offset address in the I
2C Slave RAM. \\; 0: Disable\\; 1: Enable \\.*/
...
/*description: Configures the water mark threshold of TXFIFO in nonfifo access mode.  When I2C_
FIFO_PRT_EN is 1 and TC FIFO counter is bigger than I2C_TXFIFO_WM_THRHD[4:0], I2
C_TXFIFO_WM_INT_RAW bit will be valid..*/
...
/*description: Configures the water mark threshold of RXFIFO in nonfifo access mode. When I2C_F
IFO_PRT_EN is 1 and RX FIFO counter is bigger than I2C_RXFIFO_WM_THRHD[4:0], I2C
_RXFIFO_WM_INT_RAW bit will be valid. ; \tododone{For CJ, please check this desc
ription. I habe doubt about reg_reg_fifo_prt_en.CJ: modified}.*/
...
/* I2C_FIFO_RDATA : HRO ;bitpos:[7:0] ;default: 8'b0 ; */
...
/* I2C_SLAVE_ADDR_UNMATCH_INT_RAW : R/SS/WTC ;bitpos:[18] ;default: 1'b0 ; */
...
#define I2C_SLAVE_ADDR_UNMATCH_INT_RAW_M  (BIT(18))
#define I2C_SLAVE_ADDR_UNMATCH_INT_RAW_V  0x1
...
/* I2C_SLAVE_ADDR_UNMATCH_INT_CLR : WT ;bitpos:[18] ;default: 1'b0 ; */
/*description: Write 1 to clear I2C_SLAVE_ADDR_UNMATCH_INT_RAW interrupt..*/
#define I2C_SLAVE_ADDR_UNMATCH_INT_CLR    (BIT(18))
#define I2C_SLAVE_ADDR_UNMATCH_INT_CLR_M  (BIT(18))
#define I2C_SLAVE_ADDR_UNMATCH_INT_CLR_V  0x1
...
/* I2C_SLAVE_ADDR_UNMATCH_INT_ENA : R/W ;bitpos:[18] ;default: 1'b0 ; */
/*description: Write 1 to enable I2C_SLAVE_ADDR_UNMATCH_INT interrupt..*/
#define I2C_SLAVE_ADDR_UNMATCH_INT_ENA    (BIT(18))
#define I2C_SLAVE_ADDR_UNMATCH_INT_ENA_M  (BIT(18))
#define I2C_SLAVE_ADDR_UNMATCH_INT_ENA_V  0x1
...
/* I2C_SLAVE_ADDR_UNMATCH_INT_ST : RO ;bitpos:[18] ;default: 1'b0 ; */
...
#define I2C_SLAVE_ADDR_UNMATCH_INT_ST_M  (BIT(18))
#define I2C_SLAVE_ADDR_UNMATCH_INT_ST_V  0x1
...
/*description: Configures the time to hold the data after the falling edge of SCL.\\; Measureme
nt unit: i2c_sclk \\.*/
...
/*description: Configures the time for sampling SDA.\\; Measurement unit: i2c_sclk \\.*/
...
/*description: Configures the SCL_FSM's waiting period for SCL high level in master mode.\\; Me
asurement unit: i2c_sclk \\.*/
...
/*description: Configures for how long SCL remains high in master mode.\\; Measurement unit: i2
c_sclk \\.*/
...
/*description: Configures the time between the falling edge of SDA and the falling edge of SCL
for a START condition.\\; Measurement unit: i2c_sclk \\.*/
...
/*description: Configures the time between the positive edge of SCL and the negative edge of SD
A for a RESTART condition.\\; Measurement unit: i2c_sclk \\.*/
...
/*description: Configures the delay after the STOP condition.\\; Measurement unit: i2c_sclk \\.*/
...
/*description: This register is used to configure the time between the positive edgeof SCL and
the positive edge of SDA, in I2C module clock cycles..*/
...
/*description: Configures to enable the filter function for SDA. \\; 0: No effect \\; 1: Enable
 \\.*/
...
/*description: Configures to enable the filter function for SCL. \\; 0: No effect \\; 1: Enable
 \\.*/
...
/*description: Configures the threshold pulse width to be filtered on SDA. When a pulse on the
SDA input has smaller width than this register value, the I2C controller will ig
nore that pulse. ; Measurement unit: i2c_sclk \\.*/
...
/*description: Configures the threshold pulse width to be filtered on SCL. When a pulse on the
SCL input has smaller width than this register value, the I2C controller will ig
nore that pulse. ; Measurement unit: i2c_sclk \\.*/
...
/*description: Represents whether command 0 is done in I2C Master mode.\\; 0: Not done \\; 1: D
one \\.*/
...
/*description: Configures command 0. \\; It consists of three parts:\\ ; op_code is the command
\\; 1: WRITE\\; 2: STOP\\; 3: READ\\; 4: END\\; 6: RSTART\\; Byte_num represents
 the number of bytes that need to be sent or received.\\; ack_check_en, ack_exp
and ack are used to control the ACK bit. See I2C cmd structure <a href=fig:i2c-c
md-structure">link</a> for more information. \\\tododone{for CJ, please add a hy
perlink for I2C CMD structure.CJ: done.}".*/
...
/*description: Represents whether command 1 is done in I2C Master mode.\\; 0: Not done \\; 1: D
one \\.*/
...
/*description: Represents whether command 2 is done in I2C Master mode.\\; 0: Not done \\; 1: D
one \\.*/
...
/*description: Represents whether command 3 is done in I2C Master mode.\\; 0: Not done \\; 1: D
one \\.*/
...
/*description: Represents whether command 4 is done in I2C Master mode.\\; 0: Not done \\; 1: D
one \\.*/
...
/*description: Represents whether command 5 is done in I2C Master mode.\\; 0: Not done \\; 1: D
one \\.*/
...
/*description: Represents whether command 6 is done in I2C Master mode.\\; 0: Not done \\; 1: D
one \\.*/
...
/*description: Represents whether command 7 is done in I2C Master mode.\\; 0: Not done \\; 1: D
one \\.*/
...
/* I2C_SCL_ST_TO_I2C : R/W ;bitpos:[4:0] ;default: 5'h10 ; */
/*description: Configures the threshold value of SCL_FSM state unchanged period. It should be n
o more than 23.\\; Measurement unit: i2c_sclk \\.*/
#define I2C_SCL_ST_TO_I2C    0x0000001F
#define I2C_SCL_ST_TO_I2C_M  ((I2C_SCL_ST_TO_I2C_V)<<(I2C_SCL_ST_TO_I2C_S))
#define I2C_SCL_ST_TO_I2C_V  0x1F
#define I2C_SCL_ST_TO_I2C_S  0

#define I2C_SCL_MAIN_ST_TIME_OUT_REG(i)          (REG_I2C_BASE(i) + 0x7C)
/* I2C_SCL_MAIN_ST_TO_I2C : R/W ;bitpos:[4:0] ;default: 5'h10 ; */
/*description: Configures the threshold value of SCL_MAIN_FSM state unchanged period. It should
 be no more than 23.\\; Measurement unit: i2c_sclk \\.*/
...
#define I2C_SCL_MAIN_ST_TO_I2C_V  0x1F
#define I2C_SCL_MAIN_ST_TO_I2C_S  0

#define I2C_SCL_SP_CONF_REG(i)          (REG_I2C_BASE(i) + 0x80)
/* I2C_SDA_PD_EN : R/W ;bitpos:[7] ;default: 1'b0 ; */
/*description: Configures to power down the I2C output SDA line. \\; 0: Not power down.\\; 1: N
ot work and power down.\\; Valid only when I2C_SDA_FORCE_OUT is 1..*/
...
/*description: Configures to power down the I2C output SCL line. \\; 0: Not power down.\\; 1: N
ot work and power down.\\; Valid only when I2C_SCL_FORCE_OUT is 1..*/
...
/*description: Configure the pulses of SCL generated in I2C master mode. \\; Valid when I2C_SCL
_RST_SLV_EN is 1.\\; Measurement unit: i2c_sclk \\.*/
...
/*description: Configures to send out SCL pulses when I2C master is IDLE. The number of pulses
...
/*description: Set the ACK level when slave controlling ACK level function enables.\\; 0: Low l
evel\\; 1: High level \\.*/
...
/*description: Configures to enable the function for slave to control ACK level.\\; 0: Disable
\\; 1: Enable \\.*/
...
/*description: Configures to clear the I2C slave SCL stretch function.\\; 0: No effect \\; 1: C
lear\\.*/
...
/*description: Configures to enable slave SCL stretch function. The SCL output line will be str
etched low when I2C_SLAVE_SCL_STRETCH_EN is 1 and stretch event happens. The str
etch cause can be seen in I2C_STRETCH_CAUSE.\\; 0: Disable \\; 1: Enable \\;.*/
...
/*description: Configures the time period to release the SCL line from stretching to avoid timi
ng violation. Usually it should be larger than the SDA setup time.\\; Measuremen
t unit: i2c_sclk \\.*/
...
/* I2C_DATE : R/W ;bitpos:[31:0] ;default: 32'h2404080 ; */
...
/* I2C_TXFIFO_START_ADDR : HRO ;bitpos:[31:0] ;default: 32'b0 ; */
...
/* I2C_RXFIFO_START_ADDR : HRO ;bitpos:[31:0] ;default: 32'b0 ; */
