...
typedef volatile struct {
    ...
    union {
        struct {
            ...
            uint32_t last_byte_strb                :    8;  /*Represents the effective bit of the last received data byte in SPI slave FD and HD mode. */
            uint32_t reserved20                    :    2;  /*reserved*/
            ...
            uint32_t mst_fd_wait_dma_tx_data       :    1;  /*In master full-duplex mode, 1: GP-SPI will wait DMA TX data is ready before starting SPI transfer. 0: GP-SPI does not wait DMA TX data before starting SPI transfer.*/
