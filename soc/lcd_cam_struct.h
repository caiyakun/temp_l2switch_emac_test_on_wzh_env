...
typedef volatile struct {
    ...
    union {
        struct {
            uint32_t lcd_va_height                 :    16;  /*It is the vertical active height of a frame. */
            uint32_t lcd_vt_height                 :    16;  /*It is the vertical total height of a frame. */
        };
        uint32_t val;
    } lcdcam_lcd_rgb_vertical;
    union {
        struct {
            uint32_t lcd_ha_width                  :    16;  /*It is the horizontal active width of a frame. */
            uint32_t lcd_ht_width                  :    16;  /*It is the horizontal total width of a frame. */
        };
        uint32_t val;
    } lcdcam_lcd_rgb_horizontal;
    union {
        struct {
            uint32_t lcd_hb_front                  :    16;  /*It is the horizontal blank front porch of a frame. */
            uint32_t lcd_vb_front                  :    16;  /*It is the vertical blank front porch of a frame. */
        };
        uint32_t val;
    } lcdcam_lcd_rgb_blank;
    union {
        struct {
            uint32_t lcd_vsync_width               :    10;  /*It is the position of LCD_VSYNC active pulse in a line. */
    ...
    uint32_t lcdcam_lcd_first_cmd_val;
    uint32_t lcdcam_lcd_latter_cmd_val;
    union {
        struct {
