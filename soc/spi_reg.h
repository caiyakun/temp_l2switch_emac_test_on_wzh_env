...
/* SPI_MST_FD_WAIT_DMA_TX_DATA : R/W ;bitpos:[29] ;default: 1'b0 ; */
/*description: In master full-duplex mode, 1: GP-SPI will wait DMA TX data is ready before star
ting SPI transfer. 0: GP-SPI does not wait DMA TX data before starting SPI trans
fer..*/
#define SPI_MST_FD_WAIT_DMA_TX_DATA    (BIT(29))
#define SPI_MST_FD_WAIT_DMA_TX_DATA_M  (BIT(29))
#define SPI_MST_FD_WAIT_DMA_TX_DATA_V  0x1
...
/* SPI_SLV_LAST_BYTE_STRB : R/SS ;bitpos:[19:12] ;default: 8'd0 ; */
/*description: Represents the effective bit of the last received data byte in SPI slave FD and
HD mode..*/
#define SPI_SLV_LAST_BYTE_STRB    0x000000FF
#define SPI_SLV_LAST_BYTE_STRB_M  ((SPI_SLV_LAST_BYTE_STRB_V)<<(SPI_SLV_LAST_BYTE_STRB_S))
#define SPI_SLV_LAST_BYTE_STRB_V  0xFF
...
/* SPI_DATE : R/W ;bitpos:[27:0] ;default: 28'h2207202 ; */
