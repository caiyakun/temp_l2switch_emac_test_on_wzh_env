...
/* RMT_CH0DATA : HRO ;bitpos:[31:0] ;default: 32'h0 ; */
/*description: Read and write data for channel $n via APB FIFO..*/
#define RMT_CH0DATA    0xFFFFFFFF
#define RMT_CH0DATA_M  ((RMT_CH0DATA_V)<<(RMT_CH0DATA_S))
#define RMT_CH0DATA_V  0xFFFFFFFF
#define RMT_CH0DATA_S  0

#define RMT_CH1DATA_REG          (DR_REG_RMT_BASE + 0x4)
/* RMT_CH1DATA : HRO ;bitpos:[31:0] ;default: 32'h0 ; */
/*description: Read and write data for channel $n via APB FIFO..*/
#define RMT_CH1DATA    0xFFFFFFFF
#define RMT_CH1DATA_M  ((RMT_CH1DATA_V)<<(RMT_CH1DATA_S))
#define RMT_CH1DATA_V  0xFFFFFFFF
#define RMT_CH1DATA_S  0

#define RMT_CH2DATA_REG          (DR_REG_RMT_BASE + 0x8)
/* RMT_CH2DATA : HRO ;bitpos:[31:0] ;default: 32'h0 ; */
/*description: Read and write data for channel $n via APB FIFO..*/
#define RMT_CH2DATA    0xFFFFFFFF
#define RMT_CH2DATA_M  ((RMT_CH2DATA_V)<<(RMT_CH2DATA_S))
#define RMT_CH2DATA_V  0xFFFFFFFF
#define RMT_CH2DATA_S  0

#define RMT_CH3DATA_REG          (DR_REG_RMT_BASE + 0xC)
/* RMT_CH3DATA : HRO ;bitpos:[31:0] ;default: 32'h0 ; */
/*description: Read and write data for channel $n via APB FIFO..*/
#define RMT_CH3DATA    0xFFFFFFFF
#define RMT_CH3DATA_M  ((RMT_CH3DATA_V)<<(RMT_CH3DATA_S))
#define RMT_CH3DATA_V  0xFFFFFFFF
#define RMT_CH3DATA_S  0

#define RMT_CH4DATA_REG          (DR_REG_RMT_BASE + 0x10)
/* RMT_CH4DATA : HRO ;bitpos:[31:0] ;default: 32'h0 ; */
/*description: Read and write data for channel $n via APB FIFO..*/
#define RMT_CH4DATA    0xFFFFFFFF
#define RMT_CH4DATA_M  ((RMT_CH4DATA_V)<<(RMT_CH4DATA_S))
#define RMT_CH4DATA_V  0xFFFFFFFF
#define RMT_CH4DATA_S  0

#define RMT_CH5DATA_REG          (DR_REG_RMT_BASE + 0x14)
/* RMT_CH5DATA : HRO ;bitpos:[31:0] ;default: 32'h0 ; */
/*description: Read and write data for channel $n via APB FIFO..*/
#define RMT_CH5DATA    0xFFFFFFFF
#define RMT_CH5DATA_M  ((RMT_CH5DATA_V)<<(RMT_CH5DATA_S))
#define RMT_CH5DATA_V  0xFFFFFFFF
#define RMT_CH5DATA_S  0

#define RMT_CH6DATA_REG          (DR_REG_RMT_BASE + 0x18)
/* RMT_CH6DATA : HRO ;bitpos:[31:0] ;default: 32'h0 ; */
/*description: Read and write data for channel $n via APB FIFO..*/
#define RMT_CH6DATA    0xFFFFFFFF
#define RMT_CH6DATA_M  ((RMT_CH6DATA_V)<<(RMT_CH6DATA_S))
#define RMT_CH6DATA_V  0xFFFFFFFF
#define RMT_CH6DATA_S  0

#define RMT_CH7DATA_REG          (DR_REG_RMT_BASE + 0x1C)
/* RMT_CH7DATA : HRO ;bitpos:[31:0] ;default: 32'h0 ; */
/*description: Read and write data for channel $n via APB FIFO..*/
#define RMT_CH7DATA    0xFFFFFFFF
#define RMT_CH7DATA_M  ((RMT_CH7DATA_V)<<(RMT_CH7DATA_S))
#define RMT_CH7DATA_V  0xFFFFFFFF
...
/*description: This bit is used to configure the position of carrier wave for CHANNEL$n.1'h0: a
dd carrier wave on low level.1'h1: add carrier wave on high level..*/
...
/*description: This bit is used to configure the position of carrier wave for CHANNEL$m.1'h0: a
dd carrier wave on low level.1'h1: add carrier wave on high level..*/
...
/*description: This register marks the ownership of CHANNEL$m's ram block.1'h1: Receiver is usi
ng the ram. 1'h0: APB bus is using the ram..*/
...
/* RMT_DATE : R/W ;bitpos:[27:0] ;default: 28'h2201111 ; */
